...
%     
% subplot(1,2,1)
% plot(corr_dry(qinan:lm,6),p_ref(qinan+1:lm+1))
% hold on
% plot(mean(corr_dry(qinan:lm,6))*ones(1,length(corr_dry(qinan:lm,6))),p_ref(qinan+1:lm+1),'--')
% plot(corr_moi(qinan:lm,6),p_ref(qinan+1:lm+1),'r')
% plot(mean(corr_moi(qinan:lm,6))*ones(1,length(corr_dry(qinan:lm,6))),p_ref(qinan+1:lm+1),'r--')
% set(gca,'YDir','reverse')
...
%     
% subplot(1,2,2)
% plot(corr_dry(qlnan:lm,7),p_ref(qlnan+1:lm+1))
% hold on
% plot(mean(corr_dry(qlnan:lm,7))*ones(1,length(corr_dry(qlnan:lm,7))),p_ref(qlnan+1:lm+1),'--')
% plot(corr_moi(qlnan:lm,7),p_ref(qlnan+1:lm+1),'r')
% plot(mean(corr_moi(qlnan:lm,7))*ones(1,length(corr_dry(qlnan:lm,7))),p_ref(qlnan+1:lm+1),'r--')
% set(gca,'YDir','reverse')
% xlim([0 1])
% title('Ql','FontSize',fontsize,'FontName','TimesNewRoman')
% xlim([0 0.5])
