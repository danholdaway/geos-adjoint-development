...
figure('visible','on','Position',[scrsz(1) scrsz(2) (0.21)*scrsz(3) (1.00)*scrsz(4)])
subplot(3,3,1)
plot(U_plot(top-topm:end),prefh(top-topm:end),'k')
hold on
plot(V_plot(top-topm:end),prefh(top-topm:end),'k--')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(end)])
legend('u^{(r)}','v^{(r)}')
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')
title('(a) u^{(r)}, v^{(r)} (ms^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 1.05*pos(2) pos(3) pos(4)]);

subplot(3,3,2)
plot(TH_plot(top-topm:end),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
title('(b) \theta^{(r)} (K)','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 1.05*pos(2) pos(3) pos(4)]);
...
subplot(3,3,3)
plot(Q_plot(top-topm:end),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
% set(gca,'YTickLabel',[38 42 45 48 51 54 58 63 71])
set(gca,'YTickLabel',[ 42 48  54 63 ])
% set(gca,'YTickLabel',[44 49 56 64 66 66 66 66])
ylabel('Vertical level','FontSize',fontsize,'FontName','TimesNewRoman')
title('(c) q^{(r)} (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
...
subplot(3,3,4)
plot(DUDt_plot(top-topm:end),prefh(top-topm:end),'k')
hold on
plot(DVDt_plot(top-topm:end),prefh(top-topm:end),'k--')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
xlim([-10e-5 10e-5])
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')
legend('A_u^{(r)}','A_v^{(r)}')
title('(d) A_u^{(r)}, A_v^{(r)} (ms^{-2})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 1.09*pos(2) pos(3) pos(4)]);

subplot(3,3,5)
plot(DTHDt_plot(top-topm:end),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
title('(e) H^{(r)} (Ks^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 1.09*pos(2) pos(3) pos(4)]);
...
subplot(3,3,6)
plot((DQDt_plot(top-topm:end)),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
xlim([-2*10e-8 0.2*10e-8])
% set(gca,'YTickLabel',[38 42 45 48 51 54 58 63 71])
set(gca,'YTickLabel',[ 42 48  54 63 ])
% set(gca,'YTickLabel',[44 49 56 64 66 66 66 66])
ylabel('Vertical level','FontSize',fontsize,'FontName','TimesNewRoman')
title('(f) Q^{(r)} (kgkg^{-1}s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YAxisLocation','right')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 1.09*pos(2) pos(3) pos(4)]);
...
subplot(3,3,7)
plot(PRC3_plot(top-topm:end),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
% xlim([-10e-5 10e-5])
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')
title({'(g) Precip Source';'(kgkg^{-1}s^{-1})'},'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 0.85*pos(2) pos(3) pos(4)]);

subplot(3,3,8)
plot(MFCU_plot(top-topm:end),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
title({'(h) Cumulative Mass';'Flux (kgm^{-2}s^{-1})'},'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 0.85*pos(2) pos(3) pos(4)]);
...
subplot(3,3,9)
plot((UPFR_plot(top-topm:end)),prefh(top-topm:end),'k')
set(gca,'YDir','reverse')
ylim([prefh(top-topm) prefh(Nk)])
% xlim([-2*10e-8 0.2*10e-8])
% set(gca,'YTickLabel',[38 42 45 48 51 54 58 63 71])
...
% set(gca,'YTickLabel',[44 49 56 64 66 66 66 66])
ylabel('Vertical level','FontSize',fontsize,'FontName','TimesNewRoman')
title({'(i) Updraught';' Areal Fraction'},'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YAxisLocation','right')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
pos = get(gca,'position');
set(gca,'position',[pos(1) 0.85*pos(2) pos(3) pos(4)]);
...
saveas(gcf,'profile_deep.eps', 'psc2')

% % asd
% 
% figure
% subplot(2,1,1)
% plot(DTHDt_plot,[1:72],'k')
% set(gca,'YDir','reverse')
% ylim([top-topm 72])
% % xlim([-2*10e-8 0.2*10e-8])
% title('H^{(r)} (kgkg^{-1}s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
% set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
% 
% subplot(2,1,2)
% plot((DQDt_plot),[1:72],'k')
% set(gca,'YDir','reverse')
% % ylim([prefh(top-topm) prefh(Nk)])
% ylim([top-topm 72])
% xlim([-2*10e-8 0.2*10e-8])
% title('Q^{(r)} (kgkg^{-1}s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
% set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
% 
% % asd
...
subplot(2,2,1)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Ht(top-topm:end,top-topm:end));
...
subplot(2,2,2)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Hq(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
...
subplot(2,2,4)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Mq(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
...
saveas(gcf,'jacobian_deep_hq.eps', 'psc2')


figure('visible','on','Position',[scrsz(1) scrsz(2) (0.3)*scrsz(3) (0.5)*scrsz(4)])

subplot(2,3,1)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Auu(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
title('(a) \partial A_u /\partial u (s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
...
subplot(2,3,2)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Aut(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
title('(b) \partial A_u /\partial \theta (ms^{-2}K^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Output Index (A_u)','FontSize',fontsize,'FontName','TimesNewRoman')
xlabel('Perturbation Index (\theta)','FontSize',fontsize,'FontName','TimesNewRoman')
colormap jet
colorbar
...
subplot(2,3,3)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Auq(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
title('(c) \partial A_u /\partial q (ms^{-2}kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Output Index (A_u)','FontSize',fontsize,'FontName','TimesNewRoman')
xlabel('Perturbation Index (q)','FontSize',fontsize,'FontName','TimesNewRoman')
colormap jet
colorbar
...
subplot(2,3,4)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Avv(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
title('(d) \partial A_v /\partial v (s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
...
subplot(2,3,5)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Avt(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
title('(e) \partial A_v /\partial \theta (ms^{-2}K^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Output Index (A_v)','FontSize',fontsize,'FontName','TimesNewRoman')
xlabel('Perturbation Index (\theta)','FontSize',fontsize,'FontName','TimesNewRoman')
colormap jet
colorbar
...
subplot(2,3,6)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Avq(top-topm:end,top-topm:end));
climmax = max(abs(caxis)); caxis([-climmax climmax])
set(h,'LineWidth',line_wid);
set(gca,'YDir','reverse')
title('(f) \partial A_v /\partial q (ms^{-2}kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Output Index (A_v)','FontSize',fontsize,'FontName','TimesNewRoman')
xlabel('Perturbation Index (q)','FontSize',fontsize,'FontName','TimesNewRoman')
colormap jet
colorbar
...
saveas(gcf,'jacobian_deep_a.eps', 'psc2')
