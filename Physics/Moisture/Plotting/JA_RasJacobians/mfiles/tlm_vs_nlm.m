...
figure
subplot(2,1,1)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Ht_nlm(top-topm:end,top-topm:end))
colorbar
...
subplot(2,1,2)
[C,h] = contour(Nk_vec(top-topm:end),Nk_vec(top-topm:end),J_Ht_tlm(top-topm:end,top-topm:end))
colorbar
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Output Index (H)','FontSize',fontsize,'FontName','TimesNewRoman')
