...
U_dry  = ncread('fsens.eta.dry.20120317_06z.nc4','u');
V_dry  = ncread('fsens.eta.dry.20120317_06z.nc4','v');
TV_dry = ncread('fsens.eta.dry.20120317_06z.nc4','tv');
DP_dry = ncread('fsens.eta.dry.20120317_06z.nc4','delp');
QV_dry = ncread('fsens.eta.dry.20120317_06z.nc4','sphu');
% QL_dry = ncread('fsens.eta.dry.20120317_06z.nc4','QL');
% QI_dry = ncread('fsens.eta.dry.20120317_06z.nc4','QI');
% O3_dry = ncread('fsens.eta.dry.20120317_06z.nc4','O3');

U_moi  = ncread('fsens.eta.moi.20120317_06z.nc4','u');
V_moi  = ncread('fsens.eta.moi.20120317_06z.nc4','v');
TV_moi = ncread('fsens.eta.moi.20120317_06z.nc4','tv');
DP_moi = ncread('fsens.eta.moi.20120317_06z.nc4','delp');
QV_moi = ncread('fsens.eta.moi.20120317_06z.nc4','sphu');
% QL_moi = ncread('fsens.eta.moi.20120317_06z.nc4','QL');
% QI_moi = ncread('fsens.eta.moi.20120317_06z.nc4','QI');
% O3_moi = ncread('fsens.eta.moi.20120317_06z.nc4','O3');
