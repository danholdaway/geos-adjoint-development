...
%     asd
    ...
    figure('Position',[ 164 379 1058 540])
    subplot(2,2,1)
    ...
    pos3 = get(gca,'Position');
    colbar = colorbar;
    set(gca,'Position',[pos3(1)-0.02 pos3(2) pos3(3) pos3(4)])
    title('q Difference (Dry Physics)','FontSize',fontsize,'FontName','TimesNewRoman')
    title(colbar,'(kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
    hold on; 
    plot(coast_lon,coast_lat,'Color',[grey grey grey])
    axis equal; box on; xlim([-180 180]); ylim([-90 90])
    ...
    colbar = colorbar;
    set(gca,'Position',[pos4(1) pos4(2) pos4(3) pos4(4)])
    title('q Difference (Moist Physics)','FontSize',fontsize,'FontName','TimesNewRoman')
    title(colbar,'(kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
    hold on; 
    plot(coast_lon,coast_lat,'Color',[grey grey grey])
    axis equal; box on; xlim([-180 180]); ylim([-90 90])
