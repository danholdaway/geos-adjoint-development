...
file = 'v000_C180.fvpert.eta.20140202_0300z_ST03z_P20000_S1_5_13_5.nc4';
...
cd /discover/nobackup/drholdaw/wrk.bac/sens.20140202.000000/
file = 'v000_C180.fvpert.eta.20140202_0300z_ST03z_P22000_S1_5_13_5.nc4';
...
subplot(1,7,1)
plot(corr_tl1(1:lm-LevMin+1,1),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:lm-LevMin+1,1),p(LevMin:lm),'k','LineWidth',lin_wid)
...
subplot(1,7,2)
plot(corr_tl1(1:lm-LevMin+1,2),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:lm-LevMin+1,2),p(LevMin:lm),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p(LevMin) p(lm)])
...
subplot(1,7,3)
plot(corr_tl1(1:lm-LevMin+1,3),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
...
subplot(1,7,4)
plot(corr_tl1(1:lm-LevMin+1,4),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
...
subplot(1,7,5)
plot(corr_tl1(1:lm-LevMin+1,7),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
...
subplot(1,7,6)
plot(corr_tl1(1:lm-LevMin+1,6),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
...
subplot(1,7,7)
plot(corr_tl1(1:lm-LevMin+1,5),p(LevMin:lm),'k--','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:lm-LevMin+1,5),p(LevMin:lm),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p(LevMin) p(lm)])
