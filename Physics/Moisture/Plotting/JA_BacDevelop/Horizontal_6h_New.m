...
% plot(coast_lon,coast_lat,'Color',[grey grey grey])
% caxis([-maxql maxql])
% title('(c) q_l Nonlinear Perturbation at 850hPa','FontSize',fontsize,'FontName','TimesNewRoman');
% ylabel('Latitude (\circ)','FontSize',fontsize,'FontName','TimesNewRoman')
...
% plot(coast_lon,coast_lat,'Color',[grey grey grey])
% caxis([-maxql maxql])
% title('(d) q_l Tangent Linear Perturbation at 850hPa','FontSize',fontsize,'FontName','TimesNewRoman');
% ylabel('Latitude (\circ)','FontSize',fontsize,'FontName','TimesNewRoman')
% xlabel('Longitude (\circ)','FontSize',fontsize,'FontName','TimesNewRoman')
% colormap(cmap)
% cbar = colorbar;
...
plot(coast_lon,coast_lat,'Color',[grey grey grey])
caxis([-maxqi maxqi])
title('(b) q_i Tangent Linear Perturbation at 250hPa','FontSize',fontsize,'FontName','TimesNewRoman');
ylabel('Latitude (\circ)','FontSize',fontsize,'FontName','TimesNewRoman')
colormap(cmap)
b = get(gca,'position');
set(gca,'position',[0.475 b(2) a(3) b(4)])
