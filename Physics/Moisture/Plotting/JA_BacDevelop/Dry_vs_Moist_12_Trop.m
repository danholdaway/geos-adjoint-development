...
box on
title('(g) u\prime (ms^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
...
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(h) v\prime (ms^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
...
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(i) T_v\prime (K)','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
...
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(j) q\prime (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
...
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(k) q_l\prime (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
...
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(l) q_i\prime (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')

% legend('Old BL', 'New BL','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
