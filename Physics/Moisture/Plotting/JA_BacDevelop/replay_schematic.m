...
plot(Ri(1:end),fh(1:end),'Color',[grey grey grey],'LineWidth',1.5)
% asd
hold on
plot(Ri,fm,'k','LineWidth',1.5)

% plot(Ri,fm_new,'b--')
hold on
% plot(Ri,fh_new,'r--')
legend('Background forecast','Analysis forecast','location','NorthWest')
legend boxoff
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
xlabel('Time (UTC)','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Model error','FontSize',fontsize,'FontName','TimesNewRoman')
...
annotation('doublearrow',[0.21 0.21],[0.215 0.385],'LineWidth',1.5...
...
annotation('textbox',[0.16 0.23 0.1 0.1],'String','\delta x','LineStyle','none'...
