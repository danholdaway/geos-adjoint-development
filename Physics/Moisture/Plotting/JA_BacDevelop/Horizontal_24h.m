...
file = ['v000_C180.fvpert.eta.2014020',file_end,'z_ST03z_P22000_S1_FULLLOOP.nc4'];
...
% contourf(lon,lat,ql_tlm1(:,:,plot_level_ql)','LineStyle','none')
