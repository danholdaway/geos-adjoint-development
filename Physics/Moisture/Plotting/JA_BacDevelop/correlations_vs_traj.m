...
subplot(2,1,1)
h1 = scatter(rh_cfn,cfn,0.025,'k');
hold on
h2 = plot(RH1,CF_lin ,'r','LineWidth',lin_wid);
h3 = plot(RH1,CF_tanh,'g','LineWidth',lin_wid);
box on
...
xlim([1-0.10 1+0.10])
ylim([-0.01 1.01])
legend([h2 h3],{'Linear','Nonlinear'},'Location','NorthWest');
legend boxoff
...
subplot(2,1,2)
h1 = scatter(qt_qcn-qs_qcn,qcn,0.025,'k');
hold on
h2 = plot(qmq,qcn_lin ,'r','LineWidth',lin_wid);
h3 = plot(qmq,qcn_nlin,'g','LineWidth',lin_wid);
box on
