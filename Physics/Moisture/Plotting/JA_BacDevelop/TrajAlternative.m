...
file = ['x0011dh_a.fvpert.eta.2013011',file_end,'z_BL2_MOI2_GQ0_TF900_FILT24_QLSQCN.nc4'];
% file = 'fvpert.eta.nc4'
...
figure
set(gcf,'position',[161 190 1092 418])

subplot(1,6,1)
plot(corr_dry(lev_min:lev_max,1),p_ref(lev_min+1:lev_max+1),'k--','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,1),p_ref(lev_min+1:lev_max+1),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(a) u\prime (ms^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')

subplot(1,6,2)
plot(corr_dry(lev_min:lev_max,2),p_ref(lev_min+1:lev_max+1),'k--','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,2),p_ref(lev_min+1:lev_max+1),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(b) v\prime (ms^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])

subplot(1,6,3)
plot(corr_dry(lev_min:lev_max,3),p_ref(lev_min+1:lev_max+1),'k--','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,3),p_ref(lev_min+1:lev_max+1),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(c) T_v\prime (K)','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])

subplot(1,6,4)
plot(corr_dry(lev_min:lev_max,4),p_ref(lev_min+1:lev_max+1),'k--','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,4),p_ref(lev_min+1:lev_max+1),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(d) q\prime (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])

set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')

subplot(1,6,5)
plot(corr_dry(lev_min:lev_max,7),p_ref(lev_min+1:lev_max+1),'k--','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,7),p_ref(lev_min+1:lev_max+1),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(e) q_l\prime (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YTickLabel',[])
legend('Full Traj.', 'Reduced Traj.')

set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')

subplot(1,6,6)
plot(corr_dry(lev_min:lev_max,6),p_ref(lev_min+1:lev_max+1),'k--','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,6),p_ref(lev_min+1:lev_max+1),'k','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
title('(f) q_i\prime (kgkg^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')
