...
cd /discover/nobackup/drholdaw/wrk.bac/sens.20140202.000000/
file = 'v000_C180.fvpert.eta.20140202_0300z_ST03z_P22000_S1_GQ.nc4';
...
t_tl1 = 0.5*(t_tl3 + t_tl1);
q_tl1 = 0.5*(q_tl3 + q_tl1);
qi_tl1 = 0.5*(qi_tl3 + qi_tl1);
ql_tl1 = 0.5*(ql_tl3 + ql_tl1);
...
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
xlim([0 0.4])
legend('Single Traj (averaged)','Gaussian Quad','Location','NorthEast')
