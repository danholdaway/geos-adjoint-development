...
title('T_v (K) nonlinear model perturbation','FontSize',fontsize,'FontName','TimesNewRoman')
...
set(gca,'YDir','Reverse')
set(h,'LevelStep',cint_t);
title('T_v (K) tangent linear model perturbation','FontSize',fontsize,'FontName','TimesNewRoman')
xlabel('Latitude (\circ)','FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Model Level','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
