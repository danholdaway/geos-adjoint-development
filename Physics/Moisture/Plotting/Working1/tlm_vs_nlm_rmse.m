...
%     end
    ...
    for k = 1:lm
        ...
        rms_u_a(k) = sqrt(  sum(sum(diff2_u_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_u_b(k) = sqrt(  sum(sum(diff2_u_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_u_c(k) = sqrt(  sum(sum(diff2_u_c(lon_min:lon_max,lat_min:lat_max,k))) / n );

        rms_v_a(k) = sqrt(  sum(sum(diff2_v_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_v_b(k) = sqrt(  sum(sum(diff2_v_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_v_c(k) = sqrt(  sum(sum(diff2_v_c(lon_min:lon_max,lat_min:lat_max,k))) / n );
        
        rms_t_a(k) = sqrt(  sum(sum(diff2_t_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_t_b(k) = sqrt(  sum(sum(diff2_t_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_t_c(k) = sqrt(  sum(sum(diff2_t_c(lon_min:lon_max,lat_min:lat_max,k))) / n );
        
        rms_q_a(k) = sqrt(  sum(sum(diff2_q_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_q_b(k) = sqrt(  sum(sum(diff2_q_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_q_c(k) = sqrt(  sum(sum(diff2_q_c(lon_min:lon_max,lat_min:lat_max,k))) / n );
        
        rms_p_a(k) = sqrt(  sum(sum(diff2_p_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_p_b(k) = sqrt(  sum(sum(diff2_p_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_p_c(k) = sqrt(  sum(sum(diff2_p_c(lon_min:lon_max,lat_min:lat_max,k))) / n );

        rms_qi_a(k) = sqrt(  sum(sum(diff2_qi_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_qi_b(k) = sqrt(  sum(sum(diff2_qi_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_qi_c(k) = sqrt(  sum(sum(diff2_qi_c(lon_min:lon_max,lat_min:lat_max,k))) / n );
        
        rms_ql_a(k) = sqrt(  sum(sum(diff2_ql_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_ql_b(k) = sqrt(  sum(sum(diff2_ql_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_ql_c(k) = sqrt(  sum(sum(diff2_ql_c(lon_min:lon_max,lat_min:lat_max,k))) / n );
        
        rms_o3_a(k) = sqrt(  sum(sum(diff2_o3_a(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_o3_b(k) = sqrt(  sum(sum(diff2_o3_b(lon_min:lon_max,lat_min:lat_max,k))) / n );
        rms_o3_c(k) = sqrt(  sum(sum(diff2_o3_c(lon_min:lon_max,lat_min:lat_max,k))) / n );
    end
