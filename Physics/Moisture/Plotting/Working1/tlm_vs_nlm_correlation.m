...
if makeplots == 1 
    ...
    if plot_u == 1
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((u_b_lev))','LineStyle','none');
        caxis([minu maxu])
        title('u')
        colorbar
        set(h,'LevelStep',cint_u);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((u_c_lev))','LineStyle','none');
        caxis([minu maxu])
        title('v')
        colorbar
        set(h,'LevelStep',cint_u);
    ...
    if plot_v == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((v_a_lev))','LineStyle','none');
        caxis([minv maxv])
        title('v')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((v_b_lev))','LineStyle','none');
        caxis([minv maxv])
        title('v')
        colorbar
        set(h,'LevelStep',cint_v);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((v_c_lev))','LineStyle','none');
        caxis([minv maxv])
        title('v')
        colorbar
        set(h,'LevelStep',cint_v);
    ...
    if plot_t == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((t_a_lev))','LineStyle','none');
        caxis([mint maxt])
        title('t')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((t_b_lev))','LineStyle','none');
        caxis([mint maxt])
        title('t')
        colorbar
        set(h,'LevelStep',cint_t);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((t_c_lev))','LineStyle','none');
        caxis([mint maxt])
        title('t')
        colorbar
        set(h,'LevelStep',cint_t);
    ...
    if plot_q == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((q_a_lev))','LineStyle','none');
        caxis([minq maxq])
        title('q')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((q_b_lev))','LineStyle','none');
        caxis([minq maxq])
        title('q')
        colorbar
        set(h,'LevelStep',cint_q);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((q_c_lev))','LineStyle','none');
        caxis([minq maxq])
        title('q')
        colorbar
        set(h,'LevelStep',cint_q);
    ...
    if plot_p == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((p_a_lev))','LineStyle','none');
        caxis([minp maxp])
        title('p')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((p_b_lev))','LineStyle','none');
        caxis([minp maxp])
        title('p')
        colorbar
        set(h,'LevelStep',cint_p);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((p_c_lev))','LineStyle','none');
        caxis([minp maxp])
        title('p')
        colorbar
        set(h,'LevelStep',cint_p);
    ...
    if plot_qi == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((qi_a_lev))','LineStyle','none');
        caxis([minqi maxqi])
        title('qi')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((qi_b_lev))','LineStyle','none');
        caxis([minqi maxqi])
        title('qi')
        colorbar
        set(h,'LevelStep',cint_qi);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((qi_c_lev))','LineStyle','none');
        caxis([minqi maxqi])
        title('qi')
        colorbar
        set(h,'LevelStep',cint_qi);
    ...
    if plot_ql == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((ql_a_lev))','LineStyle','none');
        caxis([minql maxql])    
        title('ql')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((ql_b_lev))','LineStyle','none');
        caxis([minql maxql])    
        title('ql')
        colorbar
        set(h,'LevelStep',cint_ql);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((ql_c_lev))','LineStyle','none');
        caxis([minql maxql])    
        title('ql')
        colorbar
        set(h,'LevelStep',cint_ql);
    ...
    if plot_o3 == 1
        ...
        subplot(3,1,1)
        [~,h] = contourf(lon,lat,((o3_a_lev))','LineStyle','none');
        caxis([mino3 maxo3])
        title('o3')
        colorbar
        ...
        subplot(3,1,2)
        [~,h] = contourf(lon,lat,((o3_b_lev))','LineStyle','none');
        caxis([mino3 maxo3])
        title('o3')
        colorbar
        set(h,'LevelStep',cint_o3);
        ...
        subplot(3,1,3)
        [~,h] = contourf(lon,lat,((o3_c_lev))','LineStyle','none');
        caxis([mino3 maxo3])
        title('o3')
        colorbar
        set(h,'LevelStep',cint_o3);
...
if calc_corr == 1
    ...
    subplot(1,8,1)
    plot(corr_dry(lev_min:lev_max,1),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,1))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,1),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,1))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,2)
    plot(corr_dry(lev_min:lev_max,2),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,2))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,2),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,2))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,3)
    plot(corr_dry(lev_min:lev_max,3),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,3))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,3),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,3))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,4)
    plot(corr_dry(lev_min:lev_max,4),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,4))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,4),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,4))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,5)
    plot(corr_dry(lev_min:lev_max,5),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,5))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,5),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,5))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,6)
    plot(corr_dry(lev_min:lev_max,6),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,6))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,6),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,6))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,7)
    plot(corr_dry(lev_min:lev_max,7),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,7))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,7),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,7))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])

    subplot(1,8,8)
    plot(corr_dry(lev_min:lev_max,8),p_ref(lev_min+1:lev_max+1))
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,8))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'--')
    plot(corr_moi(lev_min:lev_max,8),p_ref(lev_min+1:lev_max+1),'r')
    % plot(mean(corr_moi(lev_min:lev_max,8))*ones(1,lev_max-lev_min+1),p_ref(lev_min+1:lev_max+1),'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
    ...
    subplot(1,8,1)
    plot(corr_dry(lev_min:lev_max,1),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,1))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,1),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,1))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,2)
    plot(corr_dry(lev_min:lev_max,2),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,2))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,2),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,2))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,3)
    plot(corr_dry(lev_min:lev_max,3),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,3))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,3),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,3))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,4)
    plot(corr_dry(lev_min:lev_max,4),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,4))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,4),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,4))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,5)
    plot(corr_dry(lev_min:lev_max,5),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,5))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,5),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,5))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,6)
    plot(corr_dry(lev_min:lev_max,6),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,6))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,6),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,6))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,7)
    plot(corr_dry(lev_min:lev_max,7),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,7))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,7),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,7))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])

    subplot(1,8,8)
    plot(corr_dry(lev_min:lev_max,8),lev_min:lev_max)
    hold on
    % plot(mean(corr_dry(lev_min:lev_max,8))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'--')
    plot(corr_moi(lev_min:lev_max,8),lev_min:lev_max,'r')
    % plot(mean(corr_moi(lev_min:lev_max,8))*ones(1,lev_max-lev_min+1),lev_min:lev_max,'r--')
    set(gca,'YDir','reverse')
    xlim([0 1])
    ylim([lev_min lev_max])
