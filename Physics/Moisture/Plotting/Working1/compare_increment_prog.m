...
cd /gpfsm/dnb31/drholdaw/tmp.22292/nlm_runs/free/
...
cd /gpfsm/dnb31/drholdaw/tmp.22292/nlm_runs/replay/
file3 = 'x0011dh_a.prog.eta.20130116_00z.nc4';

u_b = ncread(file3,'u') - u_b;
v_b = ncread(file3,'v') - v_b;
t_b = ncread(file3,'tv') - t_b;
q_b = ncread(file3,'sphu') - q_b;
p_b = ncread(file3,'delp') - p_b;
qi_b = ncread(file3,'qitot') - qi_b;
ql_b = ncread(file3,'qltot') - ql_b;
o3_b = ncread(file3,'ozone') - o3_b;
