...
date_start = datenum(2013, 01, 29, 00, 00, 00);
...
mean_corr_u1 = zeros(num_days,3);
mean_corr_v1 = zeros(num_days,3);
mean_corr_t1 = zeros(num_days,3);
mean_corr_q1 = zeros(num_days,3);
mean_corr_p1 = zeros(num_days,3);
mean_corr_qi1 = zeros(num_days,3);
mean_corr_ql1 = zeros(num_days,3);
mean_corr_o31 = zeros(num_days,3);

mean_corr_u2 = zeros(num_days,3);
mean_corr_v2 = zeros(num_days,3);
mean_corr_t2 = zeros(num_days,3);
mean_corr_q2 = zeros(num_days,3);
mean_corr_p2 = zeros(num_days,3);
mean_corr_qi2 = zeros(num_days,3);
mean_corr_ql2 = zeros(num_days,3);
mean_corr_o32 = zeros(num_days,3);

for i = 0:num_days-1
        
    % If its the first day load data, else we'll load while examining plots
    if i == 0
        ...
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-NLM-free/'];
        cd(dir)
        ...
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-NLM-replay/'];
        cd(dir)
        file = ['u001_C180.prog.eta.',dater(1:8),'_21z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
        ...
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ1-PH0/'];
        cd(dir)
        ...
        %Load TLM state to compare.
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ1-PH1/'];
        cd(dir)
        file = ['u001_C180.fvpert.eta.',dater(1:8),'_21z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
        ...
        %Load TLM state to compare.
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ1-PH2/'];
        cd(dir)
        file = ['u001_C180.fvpert.eta.',dater(1:8),'_21z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
        ...
        %Load TLM state to compare.
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ2-PH0/'];
        cd(dir)
        ...
        %Load TLM state to compare.
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ2-PH1/'];
        cd(dir)
        file = ['u001_C180.fvpert.eta.',date00(1:8),'_00z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
        ...
        %Load TLM state to compare.
        dir = ['/archive/u/drholdaw/u001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ2-PH2/'];
        cd(dir)
        file = ['u001_C180.fvpert.eta.',date00(1:8),'_00z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
    ...
    figure
    set(gcf,'position',[1283 368 1276 576])
    ...
    fprintf('Without Quadrature \n')
    mean_corr_u1(i+1,1:3) = [ mean(corr_tl1(LevMin:LevMax,1)) mean(corr_tl2(LevMin:LevMax,1)) mean(corr_tl3(LevMin:LevMax,1)) ];
    fprintf('Mean u: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_u1(i+1,1), mean_corr_u1(i+1,2), mean_corr_u1(i+1,3), mean_corr_u1(i+1,3)-mean_corr_u1(i+1,2));
    mean_corr_v1(i+1,1:3) = [ mean(corr_tl1(LevMin:LevMax,2)) mean(corr_tl2(LevMin:LevMax,2)) mean(corr_tl3(LevMin:LevMax,2)) ];
    fprintf('Mean v: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_v1(i+1,1), mean_corr_v1(i+1,2), mean_corr_v1(i+1,3), mean_corr_v1(i+1,3)-mean_corr_v1(i+1,2));
    mean_corr_t1(i+1,1:3) = [ mean(corr_tl1(LevMin:LevMax,3)) mean(corr_tl2(LevMin:LevMax,3)) mean(corr_tl3(LevMin:LevMax,3)) ];
    fprintf('Mean T: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_t1(i+1,1), mean_corr_t1(i+1,2), mean_corr_t1(i+1,3), mean_corr_t1(i+1,3)-mean_corr_t1(i+1,2));   
    mean_corr_q1(i+1,1:3) = [ mean(corr_tl1(LevMin:LevMax,4)) mean(corr_tl2(LevMin:LevMax,4)) mean(corr_tl3(LevMin:LevMax,4)) ];
    fprintf('Mean q: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_q1(i+1,1), mean_corr_q1(i+1,2), mean_corr_q1(i+1,3), mean_corr_q1(i+1,3)-mean_corr_q1(i+1,2));
    mean_corr_p1(i+1,1:3) = [ mean(corr_tl1(LevMax:LevMax,5)) mean(corr_tl2(LevMax:LevMax,5)) mean(corr_tl3(LevMax:LevMax,5)) ];
    fprintf('Mean p: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_p1(i+1,1), mean_corr_p1(i+1,2), mean_corr_p1(i+1,3), mean_corr_p1(i+1,3)-mean_corr_p1(i+1,2));
    mean_corr_ql1(i+1,1:3) = [ mean(corr_tl1(corr_tl1_qlnan:LevMax,6)) mean(corr_tl2(corr_tl2_qlnan:LevMax,6)) mean(corr_tl3(corr_tl3_qlnan:LevMax,6)) ];
    fprintf('Mean ql: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_ql1(i+1,1), mean_corr_ql1(i+1,2), mean_corr_ql1(i+1,3), mean_corr_ql1(i+1,3)-mean_corr_ql1(i+1,2));
    mean_corr_qi1(i+1,1:3) = [ mean(corr_tl1(corr_tl1_qinan:LevMax,7)) mean(corr_tl2(corr_tl2_qinan:LevMax,7)) mean(corr_tl3(corr_tl3_qinan:LevMax,7)) ];
    fprintf('Mean qi: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_qi1(i+1,1), mean_corr_qi1(i+1,2), mean_corr_qi1(i+1,3), mean_corr_qi1(i+1,3)-mean_corr_qi1(i+1,2));
    mean_corr_o31(i+1,1:3) = [ mean(corr_tl1(LevMin:LevMax,8)) mean(corr_tl2(LevMin:LevMax,8)) mean(corr_tl3(LevMin:LevMax,8)) ];
    fprintf('Mean o3: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n\n\n', mean_corr_o31(i+1,1), mean_corr_o31(i+1,2), mean_corr_o31(i+1,3), mean_corr_o31(i+1,3)-mean_corr_o31(i+1,2));
    
    fprintf('With Quadrature \n')
    mean_corr_u2(i+1,1:3) = [ mean(corr_tl4(LevMin:LevMax,1)) mean(corr_tl5(LevMin:LevMax,1)) mean(corr_tl6(LevMin:LevMax,1)) ];
    fprintf('Mean u: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_u2(i+1,1), mean_corr_u2(i+1,2), mean_corr_u2(i+1,3), mean_corr_u2(i+1,3)-mean_corr_u2(i+1,2));
    mean_corr_v2(i+1,1:3) = [ mean(corr_tl4(LevMin:LevMax,2)) mean(corr_tl5(LevMin:LevMax,2)) mean(corr_tl6(LevMin:LevMax,2)) ];
    fprintf('Mean v: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_v2(i+1,1), mean_corr_v2(i+1,2), mean_corr_v2(i+1,3), mean_corr_v2(i+1,3)-mean_corr_v2(i+1,2));
    mean_corr_t2(i+1,1:3) = [ mean(corr_tl4(LevMin:LevMax,3)) mean(corr_tl5(LevMin:LevMax,3)) mean(corr_tl6(LevMin:LevMax,3)) ];
    fprintf('Mean T: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_t2(i+1,1), mean_corr_t2(i+1,2), mean_corr_t2(i+1,3), mean_corr_t2(i+1,3)-mean_corr_t2(i+1,2));   
    mean_corr_q2(i+1,1:3) = [ mean(corr_tl4(LevMin:LevMax,4)) mean(corr_tl5(LevMin:LevMax,4)) mean(corr_tl6(LevMin:LevMax,4)) ];
    fprintf('Mean q: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_q2(i+1,1), mean_corr_q2(i+1,2), mean_corr_q2(i+1,3), mean_corr_q2(i+1,3)-mean_corr_q2(i+1,2));
    mean_corr_p2(i+1,1:3) = [ mean(corr_tl4(LevMax:LevMax,5)) mean(corr_tl5(LevMax:LevMax,5)) mean(corr_tl6(LevMax:LevMax,5)) ];
    fprintf('Mean p: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_p2(i+1,1), mean_corr_p2(i+1,2), mean_corr_p2(i+1,3), mean_corr_p2(i+1,3)-mean_corr_p2(i+1,2));
    mean_corr_ql2(i+1,1:3) = [ mean(corr_tl4(corr_tl4_qlnan:LevMax,6)) mean(corr_tl5(corr_tl5_qlnan:LevMax,6)) mean(corr_tl6(corr_tl6_qlnan:LevMax,6)) ];
    fprintf('Mean ql: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_ql2(i+1,1), mean_corr_ql2(i+1,2), mean_corr_ql2(i+1,3), mean_corr_ql2(i+1,3)-mean_corr_ql2(i+1,2));
    mean_corr_qi2(i+1,1:3) = [ mean(corr_tl4(corr_tl4_qinan:LevMax,7)) mean(corr_tl5(corr_tl5_qinan:LevMax,7)) mean(corr_tl6(corr_tl6_qinan:LevMax,7)) ];
    fprintf('Mean qi: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_qi2(i+1,1), mean_corr_qi2(i+1,2), mean_corr_qi2(i+1,3), mean_corr_qi2(i+1,3)-mean_corr_qi2(i+1,2));
    mean_corr_o32(i+1,1:3) = [ mean(corr_tl4(LevMin:LevMax,8)) mean(corr_tl5(LevMin:LevMax,8)) mean(corr_tl6(LevMin:LevMax,8)) ];
    fprintf('Mean o3: OldBL - %6.4f  NewBL - %6.4f  Moi - %6.4f Gain: %6.4f \n\n', mean_corr_o32(i+1,1), mean_corr_o32(i+1,2), mean_corr_o32(i+1,3), mean_corr_o32(i+1,3)-mean_corr_o32(i+1,2));
    
    fprintf('u \n')
    fprintf(' %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f \n', mean_corr_u1(i+1,1), mean_corr_u1(i+1,2), mean_corr_u1(i+1,3), mean_corr_u2(i+1,1), mean_corr_u2(i+1,2), mean_corr_u2(i+1,3) );
    fprintf('v \n')
    fprintf(' %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f \n', mean_corr_v1(i+1,1), mean_corr_v1(i+1,2), mean_corr_v1(i+1,3), mean_corr_v2(i+1,1), mean_corr_v2(i+1,2), mean_corr_v2(i+1,3) );
    fprintf('t \n')
    fprintf(' %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f \n', mean_corr_t1(i+1,1), mean_corr_t1(i+1,2), mean_corr_t1(i+1,3), mean_corr_t2(i+1,1), mean_corr_t2(i+1,2), mean_corr_t2(i+1,3) );
    fprintf('q \n')
    fprintf(' %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f \n', mean_corr_q1(i+1,1), mean_corr_q1(i+1,2), mean_corr_q1(i+1,3), mean_corr_q2(i+1,1), mean_corr_q2(i+1,2), mean_corr_q2(i+1,3) );
...
for i = 0:num_days-1
    ...
    fprintf('Jan %i & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & \\\\ \n', i+1, mean_corr_u1(i+1,1), mean_corr_u1(i+1,2), mean_corr_u1(i+1,3), mean_corr_u2(i+1,1), mean_corr_u2(i+1,2), mean_corr_u2(i+1,3) );
    
end
fprintf('v \n')
for i = 0:num_days-1
  
    fprintf('Jan %i & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & \\\\ \n', i+1, mean_corr_v1(i+1,1), mean_corr_v1(i+1,2), mean_corr_v1(i+1,3), mean_corr_v2(i+1,1), mean_corr_v2(i+1,2), mean_corr_v2(i+1,3) );
    
end
fprintf('tv \n')
for i = 0:num_days-1
  
    fprintf('Jan %i & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & \\\\ \n', i+1, mean_corr_t1(i+1,1), mean_corr_t1(i+1,2), mean_corr_t1(i+1,3), mean_corr_t2(i+1,1), mean_corr_t2(i+1,2), mean_corr_t2(i+1,3) );
    
end
fprintf('sphu \n')
for i = 0:num_days-1
  
    fprintf('Jan %i & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & %6.4f & \\\\ \n', i+1, mean_corr_q1(i+1,1), mean_corr_q1(i+1,2), mean_corr_q1(i+1,3), mean_corr_q2(i+1,1), mean_corr_q2(i+1,2), mean_corr_q2(i+1,3) );
