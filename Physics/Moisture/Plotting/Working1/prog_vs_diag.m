...
qi_a = ncread(file,'cfls');
ql_a = ncread(file,'cfcn');
...
qi_b = ncread(file,'cfls');
ql_b = ncread(file,'cfcn');
...
subplot(4,2,1)
contour(lon,lat,((qi_a_lev1))','LevelStep',(maxqi1-minqi1)/15)
caxis([minqi1 maxqi1])
title(['qi Level ' num2str(plot_level1)])
colorbar

subplot(4,2,2)
contour(lon,lat,((qi_b_lev1))','LevelStep',(maxqi1-minqi1)/15)
caxis([minqi1 maxqi1])
title(['qi Level ' num2str(plot_level1)])
colorbar
    
subplot(4,2,3)
contour(lon,lat,((qi_a_lev2))','LevelStep',(maxqi2-minqi2)/15)
caxis([minqi2 maxqi2])
title(['qi Level ' num2str(plot_level2)])
colorbar

subplot(4,2,4)
contour(lon,lat,((qi_b_lev2))','LevelStep',(maxqi2-minqi2)/15)
caxis([minqi2 maxqi2])
title(['qi Level ' num2str(plot_level2)])
colorbar
    
subplot(4,2,5)
contour(lon,lat,((qi_a_lev3))','LevelStep',(maxqi3-minqi3)/15)
caxis([minqi3 maxqi3])
title(['qi Level ' num2str(plot_level3)])
colorbar

subplot(4,2,6)
contour(lon,lat,((qi_b_lev3))','LevelStep',(maxqi3-minqi3)/15)
caxis([minqi3 maxqi3])
title(['qi Level ' num2str(plot_level3)])
colorbar
    
subplot(4,2,7)
contour(lon,lat,((qi_a_lev4))','LevelStep',(maxqi4-minqi4)/15)
caxis([minqi4 maxqi4])
title(['qi Level ' num2str(plot_level4)])
colorbar

subplot(4,2,8)
contour(lon,lat,((qi_b_lev4))','LevelStep',(maxqi4-minqi4)/15)
caxis([minqi4 maxqi4])
title(['qi Level ' num2str(plot_level4)])
colorbar
...
subplot(4,2,1)
contour(lon,lat,((ql_a_lev1))','LevelStep',(maxql1-minql1)/15)
caxis([minql1 maxql1])
title(['ql Level ' num2str(plot_level1)])
colorbar

subplot(4,2,2)
contour(lon,lat,((ql_b_lev1))','LevelStep',(maxql1-minql1)/15)
caxis([minql1 maxql1])
title(['ql Level ' num2str(plot_level1)])
colorbar
    
subplot(4,2,3)
contour(lon,lat,((ql_a_lev2))','LevelStep',(maxql2-minql2)/15)
caxis([minql2 maxql2])
title(['ql Level ' num2str(plot_level2)])
colorbar

subplot(4,2,4)
contour(lon,lat,((ql_b_lev2))','LevelStep',(maxql2-minql2)/15)
caxis([minql2 maxql2])
title(['ql Level ' num2str(plot_level2)])
colorbar
    
subplot(4,2,5)
contour(lon,lat,((ql_a_lev3))','LevelStep',(maxql3-minql3)/15)
caxis([minql3 maxql3])
title(['ql Level ' num2str(plot_level3)])
colorbar

subplot(4,2,6)
contour(lon,lat,((ql_b_lev3))','LevelStep',(maxql3-minql3)/15)
caxis([minql3 maxql3])
title(['ql Level ' num2str(plot_level3)])
colorbar
    
subplot(4,2,7)
contour(lon,lat,((ql_a_lev4))','LevelStep',(maxql4-minql4)/15)
caxis([minql4 maxql4])
title(['ql Level ' num2str(plot_level4)])
colorbar

subplot(4,2,8)
contour(lon,lat,((ql_b_lev4))','LevelStep',(maxql4-minql4)/15)
caxis([minql4 maxql4])
title(['ql Level ' num2str(plot_level4)])
colorbar
