...
for i = 0:num_days-1
    ...
    %Load TLM state to compare.
    dir = ['/discover/nobackup/drholdaw/v001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ1-SHAP0-MOIST1-NEWDYN0/'];
    cd(dir)
    file = ['v001_C180.fvpert.eta.',dater(1:8),'_21z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
    ...
    q_tl4 = ncread(file,'QV');
    p_tl4 = ncread(file,'DP');
    qi_tl4 = ncread(file,'QI');
    ql_tl4 = ncread(file,'QL');
    o3_tl4 = ncread(file,'O3');

    %Load TLM state to compare.
    dir = ['/discover/nobackup/drholdaw/v001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ1-SHAP1-MOIST1-NEWDYN1/'];
    cd(dir)
    file = ['v001_C180.fvpert.eta.',dater(1:8),'_21z+',dateplot(1:8),'_',dateplot(9:10),'z.nc4'];
    ...
    q_tl5 = ncread(file,'QV');
    p_tl5 = ncread(file,'DP');
    qi_tl5 = ncread(file,'QI');
    ql_tl5 = ncread(file,'QL');
    o3_tl5 = ncread(file,'O3');

    %Load TLM state to compare.
    dir = ['/discover/nobackup/drholdaw/v001_C180/prog/Y',dater(1:4),'/M',dater(5:6),'/D',dater(7:8),'/H21-TLM-GQ2-SHAP1-MOIST1-NEWDYN1/'];
    cd(dir)
    ...
    q_tl6 = ncread(file,'QV');
    p_tl6 = ncread(file,'DP');
    qi_tl6 = ncread(file,'QI');
    ql_tl6 = ncread(file,'QL');
    o3_tl6 = ncread(file,'O3');
...
plot(corr_tl3(LevMin:LevMax,1),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,1),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,1),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
...
plot(corr_tl3(LevMin:LevMax,2),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,2),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,2),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
...
plot(corr_tl3(LevMin:LevMax,3),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,3),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,3),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
...
plot(corr_tl3(LevMin:LevMax,4),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,4),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,4),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
...
plot(corr_tl3(LevMin:LevMax,5),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,5),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,5),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
...
plot(corr_tl3(LevMin:LevMax,6),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,6),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,6),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
...
plot(corr_tl3(LevMin:LevMax,7),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,7),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,7),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
...
plot(corr_tl3(LevMin:LevMax,8),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,8),p_ref(LevMin:LevMax),'b','LineWidth',lin_wid)
plot(corr_tl6(LevMin:LevMax,8),p_ref(LevMin:LevMax),'m','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('o3 (ppm)','FontSize',fontsize1,'FontName','TimesNewRoman')
ylabel('Height (hPa)','FontSize',fontsize1,'FontName','TimesNewRoman')
legend('Control','New Dyn','Shapiro','Moist','GQ')
...
plot(corr_tl1(LevMin:LevMax,1),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,1),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,1),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('u (ms^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,2),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,2),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,2),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('v (ms^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,3),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,3),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,3),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('T_v (K)','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,4),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,4),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,4),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('q (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,5),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,5),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,5),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('p (Pa)','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,6),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,6),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,6),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('q_l (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,7),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,7),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,7),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('q_i (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
plot(corr_tl1(LevMin:LevMax,8),p_ref(LevMin:LevMax),'k','LineWidth',lin_wid)
hold on
plot(corr_tl4(LevMin:LevMax,8),p_ref(LevMin:LevMax),'r','LineWidth',lin_wid)
plot(corr_tl5(LevMin:LevMax,8),p_ref(LevMin:LevMax),'g','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 0.5])
ylim([p_ref(LevMin+1) p_ref(LevMax)])
title('o3 (ppm)','FontSize',fontsize1,'FontName','TimesNewRoman')
