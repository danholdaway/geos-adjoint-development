...
%%%%%% Q PLOTS %%%%%%%
ax(4,1) = axes('position',[pos_sp_1(1) pos_sp_1(2) pos_sp_1(3) pos_sp_1(4) ]);
...
colbar1_ticks(4,1:length(get(colbar(3,1),'Ytick'))) = get(colbar(3,1),'Ytick');
clim_old_1(:,4) = get(ax(4,1),'CLim');


%%%%%%%
ax(4,2) = axes('position',[pos_sp_1(1) pos_sp_1(2) pos_sp_1(3) pos_sp_1(4) ]);
[C3,h3] = contour(lon(loni1:loni2),lat(lati1:lati2),PRECCON_1(loni1:loni2,lati1:lati2)');
hold on
plot(boxhor,boxver(1)*ones(1,5),'k')
plot(boxhor,boxver(end)*ones(1,5),'k')
...
% colbar2_ticks = get(colbar(3,2),'Ytick');
...
title('With Dry Physics','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca, 'color', 'none');
box on; 
...
clim_new_1_diff = clim_new_1(2)-clim_new_1(1);
clim_new_1_inc = (colbar1_ticks(4,1:length(get(colbar(3,1),'Ytick')))-clim_old_1(1,4))./(clim_old_1(2,4)-clim_old_1(1,4));
clim_new_1 = clim_new_1(1) + clim_new_1_inc*clim_new_1_diff;
set(colbar(3,1),'YTick',clim_new_1)

set(colbar(3,1),'YtickLabel',{'-2', '-1.5', '-1', '-0.5', '0', '0.5', '1.0', '1.5', '2.0'})
title(colbar(3,1),'\times 10^{-5}','FontSize',fontsize,'FontName','TimesNewRoman')
...
% set(colbar(3,2),'YTick',clim_new_2)
% 
% poscbar2 = get(colbar(3,2),'Position');
% set(colbar(3,2),'Position',[0.93 0.28 poscbar2(3) 0.45])
% ylabel(colbar(3,2),'Convective Precipitation (kgm^{-2}s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
...
%%%axes('position',[pos_sp_2(1) pos_sp_2(2) pos_sp_2(3) pos_sp_2(4) ]);,2),'FontSize',fontsize,'FontName','TimesNewRoman')


%%%%%% Q PLOTS %%%%%%%
ax(4,1) = axes('position',[pos_sp_2(1) pos_sp_2(2) pos_sp_2(3) pos_sp_2(4) ]);
...
%%%%%%%
ax(4,2) = axes('position',[pos_sp_2(1) pos_sp_2(2) pos_sp_2(3) pos_sp_2(4) ]);
[C3,h3] = contour(lon(loni1:loni2),lat(lati1:lati2),PRECCON_1(loni1:loni2,lati1:lati2)');
hold on
plot(boxhor,boxver(1)*ones(1,5),'k')
plot(boxhor,boxver(end)*ones(1,5),'k')
...
title('With Moist Physics','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca, 'color', 'none');
box on; 
set(ax(4,1),'XTick',[],'Ytick',[]);
set(ax(4,2),'YTick',[10 24 38 52 66 80],'Xtick',[-100 -80 -60 -40 -20 0]);
...
ylabel(colbar(4,2),'Convective Precipitation (kgm^{-2}s^{-1})','FontSize',fontsize,'FontName','TimesNewRoman')
