...
file = ['v000_C180.fvpert.eta.2014020',file_end,'z_ST03z_P10000_S1.nc4'];
% file = 'fvpert.eta.nc4'

u_tlmdry = ncread(file,'U');
v_tlmdry = ncread(file,'V');
t_tlmdry = ncread(file,'TV');
q_tlmdry = ncread(file,'QV');
p_tlmdry = ncread(file,'DP');
qi_tlmdry = ncread(file,'QI');
ql_tlmdry = ncread(file,'QL');
o3_tlmdry = ncread(file,'O3');
...
q_tlmmoi = ncread(file,'QV');
p_tlmmoi = ncread(file,'DP');
qi_tlmmoi = ncread(file,'QI');
ql_tlmmoi = ncread(file,'QL');
o3_tlmmoi = ncread(file,'O3');
...
figure
set(gcf,'position',[1299         362        1059         547])

subplot(1,4,1)
plot(corr_dry(lev_min:lev_max,1),p_ref(lev_min+1:lev_max+1),'b','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,1),p_ref(lev_min+1:lev_max+1),'r','LineWidth',lin_wid)
...
subplot(1,4,2)
plot(corr_dry(lev_min:lev_max,2),p_ref(lev_min+1:lev_max+1),'b','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,2),p_ref(lev_min+1:lev_max+1),'r','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
...
subplot(1,4,3)
plot(corr_dry(lev_min:lev_max,3),p_ref(lev_min+1:lev_max+1),'b','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,3),p_ref(lev_min+1:lev_max+1),'r','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
...
subplot(1,4,4)
plot(corr_dry(lev_min:lev_max,4),p_ref(lev_min+1:lev_max+1),'b','LineWidth',lin_wid)
hold on
plot(corr_moi(lev_min:lev_max,4),p_ref(lev_min+1:lev_max+1),'r','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([p_ref(lev_min+1) p_ref(lev_max+1)])
box on
...
legend('Old BL', 'New BL','location','NorthEast')
legend boxoff
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')
ylabel('Pressure (hPa)','FontSize',fontsize,'FontName','TimesNewRoman')
set(gca,'YAxisLocation','right')
