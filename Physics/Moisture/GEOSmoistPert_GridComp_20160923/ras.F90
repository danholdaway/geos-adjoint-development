...
!   use aer_cloud
   ...
   PRIVATE
   PUBLIC RASE, RASE_FAST, RASE_NOWINDS
...
!            N_DTL = min( int( RASNCL ) , K-ICMIN )
   ...
   SUBROUTINE RASE_NOWINDS(IDIM, IRUN, K0, ICMIN, DT,                     &
         CPO,ALHLO,ALHL1,TICE,GRAVO,                      &
         SEEDRAS,SIGE,                          &
         KCBL,WGT0,WGT1,TPERT,QPERT,          &
         THO, QHO,                              & 
...
!      INTEGER, DIMENSION(IDIM,K0), INTENT(  OUT) ::  IRC
      ...
      REAL(8),  DIMENSION(K0) :: POI_SV, QOI_SV
      REAL(8),  DIMENSION(K0) :: POI, QOI, DQQ, BET, GAM, CLL, TMPT
      REAL(8),  DIMENSION(K0) :: POI_c, QOI_c
      REAL(8),  DIMENSION(K0) :: PRH,  PRI,  GHT, DPT, DPB, PKI, DISSK0,DISSK1, CLANTND
      REAL(8),  DIMENSION(K0) :: TCU, QCU, UCU, VCU,  CLN, RNS, POL,DM
      REAL(8),  DIMENSION(K0) :: QST, SSL,  RMF, RNN, RN1, RMFC, RMFP
