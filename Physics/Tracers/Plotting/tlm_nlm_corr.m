...
cd /discover/nobackup/drholdaw/wrk.dust/prog/prog_free/
file = ['C360_513_snamma.prog.eta.2006082',file_end(1:4),'z.nc4'];
...
d1_free = zeros(im,jm,lm);%ncread(file,'DU001',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d2_free = zeros(im,jm,lm);%ncread(file,'DU002',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d3_free = zeros(im,jm,lm);%ncread(file,'DU003',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d4_free = zeros(im,jm,lm);%ncread(file,'DU004',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d5_free = zeros(im,jm,lm);%ncread(file,'DU005',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);

%Load Perturbed (analysis) st
cd /discover/nobackup/drholdaw/wrk.dust/prog/prog_replay/
file = ['C360_513_snamma.prog.eta.2006082',file_end(1:4),'z.nc4'];
...
d1_replay = zeros(im,jm,lm);%ncread(file,'DU001',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d2_replay = zeros(im,jm,lm);%ncread(file,'DU002',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d3_replay = zeros(im,jm,lm);%ncread(file,'DU003',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d4_replay = zeros(im,jm,lm);%ncread(file,'DU004',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d5_replay = zeros(im,jm,lm);%ncread(file,'DU005',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);

%Load first TLM state to compare.
cd /discover/nobackup/drholdaw/wrk.dust/sens.20060828.000000/
file = ['C360_513_snamma.fvpert.eta.2006082',file_end,'z_ST03z_P20000.nc4'];
...
d1_tl1 = zeros(im,jm,lm);%ncread(file,'DU001',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d2_tl1 = zeros(im,jm,lm);%ncread(file,'DU002',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d3_tl1 = zeros(im,jm,lm);%ncread(file,'DU003',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d4_tl1 = zeros(im,jm,lm);%ncread(file,'DU004',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d5_tl1 = zeros(im,jm,lm);%ncread(file,'DU005',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);

%Load second TLM state to compare.
cd /discover/nobackup/drholdaw/wrk.dust/sens.20060828.000000/
file = ['C360_513_snamma.fvpert.eta.2006082',file_end,'z_ST03z_P20000_DT900.nc4'];
% file = 'fvpertX.eta.nc4';
...
d1_tl2 = zeros(im,jm,lm);%ncread(file,'DU001',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d2_tl2 = zeros(im,jm,lm);%ncread(file,'DU002',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d3_tl2 = zeros(im,jm,lm);%ncread(file,'DU003',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d4_tl2 = zeros(im,jm,lm);%ncread(file,'DU004',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
d5_tl2 = zeros(im,jm,lm);%ncread(file,'DU005',[1 1 LevMin 1],[Inf Inf LevMax-LevMin+1 Inf]);
...
subplot(2,8,1)
plot(corr_tl1(1:LevMax-LevMin+1,1),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,1),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('u (ms^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
ylabel('Model Level','FontSize',fontsize1,'FontName','TimesNewRoman')
set(gca,'FontSize',fontsize,'FontName','TimesNewRoman')

subplot(2,8,2)
plot(corr_tl1(1:LevMax-LevMin+1,2),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,2),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('v (ms^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,3)
plot(corr_tl1(1:LevMax-LevMin+1,3),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,3),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('T_v (K)','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,4)
plot(corr_tl1(1:LevMax-LevMin+1,4),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,4),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('q (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,5)
plot(corr_tl1(1:LevMax-LevMin+1,5),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,5),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('p (Pa)','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,6)
plot(corr_tl1(1:LevMax-LevMin+1,6),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,6),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('q_l (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,7)
plot(corr_tl1(1:LevMax-LevMin+1,7),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,7),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('q_i (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,8)
plot(corr_tl1(1:LevMax-LevMin+1,8),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,8),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
xlim([0 1])
ylim([LevMin+1 LevMax])
title('o3 (ppm)','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,9)
plot(corr_tl1(1:LevMax-LevMin+1,9),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,9),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
% xlim([0 1])
ylim([LevMin+1 LevMax])
title('DU B1 (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,10)
plot(corr_tl1(1:LevMax-LevMin+1,10),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,10),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
% xlim([0 1])
ylim([LevMin+1 LevMax])
title('DU B2 (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,11)
plot(corr_tl1(1:LevMax-LevMin+1,11),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,11),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
% xlim([0 1])
ylim([LevMin+1 LevMax])
title('DU B3 (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,12)
plot(corr_tl1(1:LevMax-LevMin+1,12),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,12),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
% xlim([0 1])
ylim([LevMin+1 LevMax])
title('DU B4 (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
...
subplot(2,8,13)
plot(corr_tl1(1:LevMax-LevMin+1,13),LevMin+1:LevMax+1,'b','LineWidth',lin_wid)
hold on
plot(corr_tl2(1:LevMax-LevMin+1,13),LevMin+1:LevMax+1,'r-','LineWidth',lin_wid)
set(gca,'YDir','reverse')
% xlim([0 1])
ylim([LevMin+1 LevMax])
title('DU B5 (kgkg^{-1})','FontSize',fontsize1,'FontName','TimesNewRoman')
