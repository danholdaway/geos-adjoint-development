...
cd /discover/nobackup/drholdaw/btmp.25956/prog/prog_free_nosinks/
...
cd /discover/nobackup/drholdaw/btmp.25956/prog/prog_replay_nosinks/
file = ['v000_C180.prog.eta.2014020',file_end,'z.nc4'];
...
file = ['v000_C180.fvpert.eta.2014020',file_end,'z_ST03z_P2Tk000_S1.nc4'];
...
cd /discover/nobackup/drholdaw/btmp.25956/sens.20140202.000000/
file = ['v000_C180.fvpert.eta.2014020',file_end,'z_ST03z_P2Tl000_S1.nc4'];
% file = 'fvpertX.eta.nc4';
