...
& mpp_update_domains_tlm, domain2d
  USE FV_RESTART_MOD_DIFF, ONLY : d2a_setup, d2c_setup, d2c_setup_tlm
...
& , fv_grid_bounds_type
  USE FV_GRID_UTILS_MOD_DIFF, ONLY : ptop_min, g_sum, g_sum_tlm, &
& cubed_to_latlon, f_p
...
& , rvgas, cp_vapor, kappa
  ...
  USE SW_CORE_MOD_DIFF, ONLY : divergence_corner, divergence_corner_tlm,&
& divergence_corner_nest, divergence_corner_nest_tlm
  IMPLICIT NONE
...
&             )*cv_vap + q_liq*c_liq + q_sol*c_ice
            ...
            arg1 = rdg*delpbc(i, j, k)*ptbc(i, j, k)*(1.+dp1)*(1.-q_con)&
&             /delzbc(i, j, k)
            arg2 = cappabc(i, j, k)*LOG(arg1)
            pkz = EXP(arg2)
