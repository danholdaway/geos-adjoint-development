...
!***********************************************************************
! $Id: init_hydro.F90,v 1.2.2.1.2.1.2.1.10.1.12.1.88.1.20.2.2.2.2.1.4.1 2017/07/14 14:54:29 bmauer Exp $
...
!---- version number -----
      character(len=128) :: version = '$Id: init_hydro.F90,v 1.2.2.1.2.1.2.1.10.1.12.1.88.1.20.2.2.2.2.1.4.1 2017/07/14 14:54:29 bmauer Exp $'
