...
subroutine tracer_2d_1L(q, dp1, mfx, mfy, cx, cy, gridstruct, bd, domain, npx, npy, npz,   &
                        ...
                        hord_pert, nord_tr_pert, trdm_pert, split_damp_tr, dpA)
...
!$OMP                          private(fx,fy)
        ...
        if ( nsplt /= 1 ) then
           ...
           call fv_tp_2d_fb(qn2(isd:ied,jsd:jed,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
           ...
           call fv_tp_2d(qn2(isd:ied,jsd:jed,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
                         ...
                         gridstruct, bd, ra_x, ra_y, mfx=mfx(is:ie+1,js:je,k), mfy=mfy(is:ie,js:je+1,k))
           !UNCOMcall fv_tp_2d(qn2(isd:ied,jsd:jed,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
           ...
           call fv_tp_2d(q(isd:ied,jsd:jed,k,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
                         npx, npy, hord_pert, fx, fy, xfx(is:ie+1,jsd:jed,k), yfx(isd:ied,js:je+1,k), &
                         gridstruct, bd, ra_x, ra_y, mfx=mfx(is:ie+1,js:je,k), mfy=mfy(is:ie,js:je+1,k))
           !UNCOMcall fv_tp_2d(q(isd:ied,jsd:jed,k,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
           !UNCOM              npx, npy, hord, fx, fy, xfx(is:ie+1,jsd:jed,k), yfx(isd:ied,js:je+1,k), &
           !UNCOM              gridstruct, bd, ra_x, ra_y, mfx=mfx(is:ie+1,js:je,k), mfy=mfy(is:ie,js:je+1,k))
           endif
           do j=js,je
       ...
       if ( it .le. ksplt(k) ) then
         ...
         if ( it==1 .and. trdm>1.e-4 ) then
            ...
            call fv_tp_2d(q(isd:ied,jsd:jed,k,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
                          npx, npy, hord_pert, fx, fy, xfx(is:ie+1,jsd:jed,k), yfx(isd:ied,js:je+1,k), &
                          gridstruct, bd, ra_x, ra_y, mfx=mfx(is:ie+1,js:je,k), mfy=mfy(is:ie,js:je+1,k),   &
                          mass=dp1(isd:ied,jsd:jed,k), nord=nord_tr_pert, damp_c=trdm_pert)
            !UNCOMcall fv_tp_2d(q(isd:ied,jsd:jed,k,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
            !UNCOM              npx, npy, hord, fx, fy, xfx(is:ie+1,jsd:jed,k), yfx(isd:ied,js:je+1,k), &
            !UNCOM              gridstruct, bd, ra_x, ra_y, mfx=mfx(is:ie+1,js:je,k), mfy=mfy(is:ie,js:je+1,k),   &
            !UNCOM              mass=dp1(isd:ied,jsd:jed,k), nord=nord_tr, damp_c=trdm)
            endif
         else
            if (hord == hord_pert) then
            call fv_tp_2d_fb(q(isd:ied,jsd:jed,k,iq), cx(is:ie+1,jsd:jed,k), cy(isd:ied,js:je+1,k), &
...
subroutine tracer_2d_nested(q, dp1, mfx, mfy, cx, cy, gridstruct, bd, domain, npx, npy, npz,   &
                     ...
                     hord_pert, nord_tr_pert, trdm_pert, split_damp_tr)
