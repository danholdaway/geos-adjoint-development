...
! damping on delp and vorticity:
       ...
       if ( k .le. flagstructp%n_sponge_pert ) then
         ...
         nord_k_pert=0
         if ( k == 1 ) then
            d2_divg_pert = max(0.01, flagstructp%d2_bg_pert, flagstructp%d2_bg_k1_pert)
         elseif (k == 2) then
            d2_divg_pert = max(0.01, flagstructp%d2_bg_pert, flagstructp%d2_bg_k2_pert)
         else
            d2_divg_pert = max(0.01, flagstructp%d2_bg_pert, flagstructp%d2_bg_ks_pert)
         endif
         nord_w_pert=0
