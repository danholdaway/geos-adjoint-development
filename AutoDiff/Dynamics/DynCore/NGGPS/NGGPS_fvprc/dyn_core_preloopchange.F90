...
do k=2,npz+1
   if ( a2b_ord==4 ) then
      call a2b_ord4_fb(pk(isd:ied,jsd:jed,k), wk, gridstruct, npx, npy, is, ie, js, je, ng, .true.)
   else
      call a2b_ord2(pk(isd:ied,jsd:jed,k), wk, gridstruct, npx, npy, is, ie, js, je, ng, .true.)
   endif
enddo
...
do k=1,npz+1
   if ( a2b_ord==4 ) then
      call a2b_ord4_fb( gz(isd:ied,jsd:jed,k), wk, gridstruct, npx, npy, is, ie, js, je, ng, .true.)
   else
      call a2b_ord2( gz(isd:ied,jsd:jed,k), wk, gridstruct, npx, npy, is, ie, js, je, ng, .true.)
   endif
enddo
...
!$AD II-LOOP
      ...
      if ( a2b_ord==4 ) then
         call a2b_ord4_fb(delp(isd:ied,jsd:jed,k), wk, gridstruct, npx, npy, is, ie, js, je, ng)
      else
         call a2b_ord2(delp(isd:ied,jsd:jed,k), wk, gridstruct, npx, npy, is, ie, js, je, ng)
      endif
   endif
