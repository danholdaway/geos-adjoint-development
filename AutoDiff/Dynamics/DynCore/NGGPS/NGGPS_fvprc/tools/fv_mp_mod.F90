...
! -----------------------
      ...
      subroutine start_var_group_update_2d(group, group_tl, array, domain, flags, position, whalo, ehalo, shalo, nhalo, complete)
        type(group_halo_update_type), intent(inout) :: group, group_tl
        real(FVPRC), dimension(:,:),         intent(inout) :: array
      ...
      subroutine start_var_group_update_3d(group, group_tl, array, domain, flags, position, whalo, ehalo, shalo, nhalo, complete)
        type(group_halo_update_type), intent(inout) :: group, group_tl
        real(FVPRC), dimension(:,:,:),       intent(inout) :: array
        type(domain2D),               intent(inout) :: domain
        integer,           optional,  intent(in)    :: flags
      ...
      subroutine start_var_group_update_4d(group, group_tl, array, domain, flags, position, whalo, ehalo, shalo, nhalo, complete)
        type(group_halo_update_type), intent(inout) :: group, group_tl
        real(FVPRC), dimension(:,:,:,:),     intent(inout) :: array
        type(domain2D),               intent(inout) :: domain
        integer,           optional,  intent(in)    :: flags
      ...
      subroutine start_vector_group_update_2d(group, group_tl, u_cmpt, v_cmpt, domain, flags, gridtype, whalo, ehalo, &
                                               shalo, nhalo, complete)
        type(group_halo_update_type), intent(inout) :: group, group_tl
        real(FVPRC),       dimension(:,:),   intent(inout) :: u_cmpt, v_cmpt
        type(domain2d),               intent(inout) :: domain
        integer,            optional, intent(in)    :: flags
      ...
      subroutine start_vector_group_update_3d(group, group_tl, u_cmpt, v_cmpt, domain, flags, gridtype, &
...
! --------------------------
      ...
      subroutine complete_group_halo_update(group, group_tl, domain)
        type(group_halo_update_type), intent(inout) :: group, group_tl
        !real(FVPRC), dimension(:,:),         intent(inout) :: array
        type(domain2D),               intent(inout) :: domain
      ! Arguments: 
