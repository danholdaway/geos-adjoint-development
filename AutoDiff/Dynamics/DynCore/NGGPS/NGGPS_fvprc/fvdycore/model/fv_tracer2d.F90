...
subroutine tracer_2d_1L(q, dp0, mfx, mfy, cx, cy, gridstruct, neststruct, bd, domain, npx, npy, npz, Qs, nq, hord,  &
...
subroutine tracer_2d(q, dp1, mfx, mfy, cx, cy, gridstruct, bd, domain, npx, npy, npz,   &
                     Qs, nq,  hord, q_split, dt, id_divg, q_pack, z_tracer, k_split, dpA)
...
#else
!$OMP parallel do default(none) shared(is,ie,js,je,isd,ied,jsd,jed,npz,area,xfx,  &
