...
!---- version number -----
   character(len=128) :: version = '$Id: tp_core.F90,v 1.1.2.1.2.1.30.1.88.2.12.1.2.1.4.1 2017/02/16 03:47:48 aoloso Exp $'
...
! Local:
  ...
  if( ord_ou < 0 ) then
      call xppm0(fx, q_i, crx(is,js), ord_ou, is, ie, js, je, npx,npy, bd, gridstruct%dxa, gridstruct%nested, gridstruct%grid_type)
  else
