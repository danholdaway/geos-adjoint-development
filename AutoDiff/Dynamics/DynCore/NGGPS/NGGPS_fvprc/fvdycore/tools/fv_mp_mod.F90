...
#include "mpif.h"
      ...
      type(domain2D), pointer, save :: domain
      ...
      public npes_x,npes_y,gid,masterproc,tile
...
!---- version number -----
      character(len=128) :: version = '$Id: fv_mp_mod.F90,v 1.1.2.1.2.1.2.1.22.1.8.2.48.2.4.2.2.2.2.1 2017/02/16 03:47:48 aoloso Exp $'
...
!
      subroutine domain_decomp(npx,npy,nregions,grid_type,nested,Atm,layout,io_layout)
         ...
         type(domain2D), pointer :: domain_for_coupler
