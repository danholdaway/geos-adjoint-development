...
module sorted_index_mod
  ...
  !---- version number -----
  character(len=128) :: version = '$Id: sorted_index.F90,v 1.1.1.1.128.1.20.1.2.1.4.1 2017/02/16 03:47:48 aoloso Exp $'
...
contains
  ...
  subroutine sorted_inta(isd, ied, jsd, jed, cubed_sphere, bgrid, iinta, jinta)
    ...
    ! local variables                                                  !
    !------------------------------------------------------------------!
    real(FVPRC),    dimension(4) :: xsort, ysort
  ...
  contains
    ...
    subroutine sort_rectangle(iind, jind)
      ...
      ! local variables                                                !
      !----------------------------------------------------------------!
      real(FVPRC),    dimension(4) :: xsorted, ysorted
  ...
  subroutine sorted_intb(isd, ied, jsd, jed, is, ie, js, je, npx, npy, &
    ...
    ! local variables                                                  !
    !------------------------------------------------------------------!
    real(FVPRC),    dimension(4) :: xsort, ysort, xsorted, ysorted 
