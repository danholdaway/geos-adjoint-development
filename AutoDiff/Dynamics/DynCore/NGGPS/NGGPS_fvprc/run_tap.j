...
#
#$TAPENADE_HOME/bin/tapenade ${opts} -d -O tlm/ -head "fv_dynamics_mod.fv_dynamics (u v pt delp q w delz)/(u v pt delp q w delz)"  fv_dynamics.F90 a2b_edge.F90 dyn_core.F90 fv_arrays.F90 fv_grid_utils.F90 fv_mapz.F90 fv_tracer2d.F90 nh_core.F90 sw_core.F90 tp_core.F90 MAPL/*.F90 tools/*.F90 fms/*.F90 
#
#cd tlm/
#
...
#rm -f mpp* init_hydro_tlm.F90 fv_restart_tlm.F90 fv_mp_tlm.F90 fv_arrays_tlm.F90 fms_io_tlm.F90
#
##Switch setting to zero from r8 to FVPRC
#sed -i -- 's/ = 0.0_8/ = 0.0_FVPRC/g' *_tlm.F90
#sed -i -- 's/0.0_8/0.0_FVPRC/g' *_tlm.F90
#
...
$TAPENADE_HOME/bin/tapenade ${opts} -b -O adm/ -head "fv_dynamics_mod.fv_dynamics_dummy (u v pt delp q w delz)/(u v pt delp q w delz)"  fv_dynamics.F90 a2b_edge.F90 dyn_core.F90 fv_arrays.F90 fv_grid_utils.F90 fv_mapz.F90 fv_tracer2d.F90 nh_core.F90 sw_core.F90 tp_core.F90 MAPL/*.F90 tools/*.F90 fms/*.F90 -nocheckpoint "a2b_edge_mod.a2b_ord2 a2b_edge_mod.a2b_ord4_fb a2b_edge_mod.extrap_corner_fb  dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed fv_dynamics_mod.fv_dynamics fv_dynamics_mod.rayleigh_super fv_dynamics_mod.rayleigh_friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_grid_utils_mod.cubed_to_latlon fv_grid_utils_mod.c2l_ord4 fv_grid_utils_mod.c2l_ord2 fv_mapz_mod.lagrangian_to_eulerian fv_mapz_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z_fb fv_mapz_mod.map_scalar_fb fv_mapz_mod.map1_ppm_fb fv_mapz_mod.mapn_tracer_fb fv_mapz_mod.map1_q2_fb fv_mapz_mod.map1_cubic fv_mapz_mod.scalar_profile_linear_fb fv_mapz_mod.cs_profile_linear_fb fv_mapz_mod.steepz fv_tracer2d_mod.tracer_2d fv_tracer2d_mod.tracer_2d_nested nh_core_mod.update_dz_c nh_core_mod.update_dz_d nh_core_mod.riem_solver_c nh_core_mod.riem_solver3 nh_core_mod.rim_2d nh_core_mod.sim3_solver nh_core_mod.sim3p0_solver nh_core_mod.sim1_solver nh_core_mod.sim_solver nh_core_mod.edge_profile sw_core_mod.c_sw sw_core_mod.d_sw sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.edge_interpolate4 sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.compute_div_damping_fb sw_core_mod.smag_corner_fb sw_core_mod.ytp_v_fb sw_core_mod.xtp_u_fb tp_core_mod.fv_tp_2d_fb tp_core_mod.copy_corners_fb tp_core_mod.xtp_fb tp_core_mod.ytp_fb tp_core_mod.xppm0_fb tp_core_mod.yppm0_fb tp_core_mod.fxppm_fb tp_core_mod.fyppm_fb tp_core_mod.deln_flux_fb"

cd adm/
rename mod_b.f90 adm.F90 *mod_b.f90

#Remove files we do not need
rm -f mpp* init_hydro_adm.F90 fv_restart_adm.F90 fv_arrays_adm.F90 fms_io_adm.F90
...
#Switch from R8 to FVPRC
# e.g. br_tl = 0.0_8 -> 0.0_FVPRC
sed -i -- 's/0.0_8/0.0_FVPRC/g' *0

#In CP calls replace fvprc with 8 as that is how code is built
#e.g. call pushrealarray(br, fvprc*(dimbr)/8) -> call pushrealarray(br, 8*(dimbr)/8)
#otherwise wrong #of bits when checkpointing in single precision compile
sed -i -- 's/, fvprc/, 8/g' *0

#Replace 8/8 with nothing to avoid superfluous calculations
#e.g. call pushrealarray(scalar, 8/8) -> call pushrealarray(scalar)
sed -i -- 's@, 8/8@@g' *0

#Switch reals to fv_checkpointing.F90 Tapenade interface
...
#Controls
sed -i -- 's/CALL PUSHCONTROL1B/CALL PUSHCONTROL1B_FV/g' *0
sed -i -- 's/CALL PUSHCONTROL2B/CALL PUSHCONTROL2B_FV/g' *0
sed -i -- 's/CALL PUSHCONTROL3B/CALL PUSHCONTROL3B_FV/g' *0
sed -i -- 's/CALL POPCONTROL1B/CALL POPCONTROL1B_FV/g' *0
sed -i -- 's/CALL POPCONTROL2B/CALL POPCONTROL2B_FV/g' *0
sed -i -- 's/CALL POPCONTROL3B/CALL POPCONTROL3B_FV/g' *0
...
#Switch reals to fv_checkpointing.F90 Tapenade interface
sed -i -- 's/CALL PUSHREAL8ARRAY/CALL PUSHREALARRAY_ADM/g' *0
sed -i -- 's/CALL POPREAL8ARRAY/CALL POPREALARRAY_ADM/g' *0
