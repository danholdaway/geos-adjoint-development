...
!  Differentiation of fill_corners_2d_r8 in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_mod.a2b_
!ord4_fb a2b_edge_mod.extrap_corner  dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dy
!n_core_mod.adv_pe dyn_core_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.gr
!ad1_p_update dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed fv_dynamics_mod.fv_dynamics fv_dynamics_mod.rayleigh
!_super fv_dynamics_mod.rayleigh_friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_grid_utils_mod.cubed_to_latl
!on fv_grid_utils_mod.c2l_ord4 fv_grid_utils_mod.c2l_ord2 fv_mapz_mod.lagrangian_to_eulerian fv_mapz_mod.compute_total_energy fv_
!mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_tracer fv_mapz_mod.ma
!p1_q2_fb fv_mapz_mod.map1_cubic fv_mapz_mod.scalar_profile_linear fv_mapz_mod.cs_profile_linear fv_mapz_mod.steepz fv_trac
!er2d_mod.tracer_2d fv_tracer2d_mod.tracer_2d_nested nh_core_mod.update_dz_c nh_core_mod.update_dz_d nh_core_mod.riem_solver_c nh
!_core_mod.riem_solver3 nh_core_mod.rim_2d nh_core_mod.sim3_solver nh_core_mod.sim3p0_solver nh_core_mod.sim1_solver nh_core_mod.
!sim_solver nh_core_mod.edge_profile sw_core_mod.c_sw sw_core_mod.d_sw sw_core_mod.divergence_corner sw_core_mod.divergence_corne
!r_nest sw_core_mod.d2a2c_vect sw_core_mod.edge_interpolate4 sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.com
!pute_div_damping_fb sw_core_mod.smag_corner sw_core_mod.ytp_v sw_core_mod.xtp_u tp_core_mod.fv_tp_2d tp_core_mod.cop
!y_corners_fb tp_core_mod.xtp tp_core_mod.ytp tp_core_mod.xppm0 tp_core_mod.yppm0 tp_core_mod.fxppm tp_core_mod.fy
!ppm_fb tp_core_mod.deln_flux)):
          ...
          DO j=ng,1,-1
            DO i=ng,1,-1
              ...
              IF (branch .NE. 0) THEN
                ...
                q_ad(npx-1+i, npy-1+j) = 0.0_FVPRC
          ...
          DO j=ng,1,-1
            DO i=ng,1,-1
              ...
              IF (branch .NE. 0) THEN
                ...
                q_ad(npx-1+j, npy-1+i) = 0.0_FVPRC
...
!  Differentiation of fill_corners_xy_2d_r8 in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_mod.a
...
!  Differentiation of fill_corners_agrid_r8 in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_mod.a
!2b_ord4_fb a2b_edge_mod.extrap_corner  dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo
! dyn_core_mod.adv_pe dyn_core_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod
!.grad1_p_update dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed fv_dynamics_mod.fv_dynamics fv_dynamics_mod.rayle
!igh_super fv_dynamics_mod.rayleigh_friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_grid_utils_mod.cubed_to_l
...
!  Differentiation of fill_corners_cgrid_r8 in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_mod.a
!2b_ord4_fb a2b_edge_mod.extrap_corner  dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo
! dyn_core_mod.adv_pe dyn_core_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod
!.grad1_p_update dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed fv_dynamics_mod.fv_dynamics fv_dynamics_mod.rayle
!igh_super fv_dynamics_mod.rayleigh_friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_grid_utils_mod.cubed_to_l
    ...
    DO j=ng,1,-1
      DO i=ng,1,-1
        ...
        IF (branch .NE. 0) THEN
          ...
          x_ad(npx+i, npy-1+j) = 0.0_FVPRC
        END IF
        CALL POPCONTROL1B(branch)
        IF (branch .EQ. 0) THEN
          y_ad(npx-j, 1-i) = y_ad(npx-j, 1-i) + mysign*x_ad(npx+i, 1-j)
          x_ad(npx+i, 1-j) = 0.0_FVPRC
        END IF
        CALL POPCONTROL1B(branch)
        IF (branch .EQ. 0) THEN
...
!  Differentiation of fill_corners_dgrid_r8 in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_mod.a
!2b_ord4_fb a2b_edge_mod.extrap_corner  dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo
! dyn_core_mod.adv_pe dyn_core_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod
!.grad1_p_update dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed fv_dynamics_mod.fv_dynamics fv_dynamics_mod.rayle
!igh_super fv_dynamics_mod.rayleigh_friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_grid_utils_mod.cubed_to_l
...
! -----------------------
  SUBROUTINE START_VAR_GROUP_UPDATE_2D(group, group_tl, array, domain, &
&   flags, position, whalo, ehalo, shalo, nhalo, complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
    REAL(fvprc), DIMENSION(:, :), INTENT(INOUT) :: array
    TYPE(DOMAIN2D), INTENT(INOUT) :: domain
...
!  Differentiation of start_var_group_update_3d in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_m
...
!   with respect to varying inputs: array
  SUBROUTINE START_VAR_GROUP_UPDATE_3D_ADM(group, group_tl, array, &
&   array_ad, domain, flags, position, whalo, ehalo, shalo, nhalo, &
&   complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
    REAL(fvprc), DIMENSION(:, :, :), INTENT(INOUT) :: array
    REAL(fvprc), DIMENSION(:, :, :), INTENT(INOUT) :: array_ad
    TYPE(DOMAIN2D), INTENT(INOUT) :: domain
    INTEGER, OPTIONAL, INTENT(IN) :: flags
    INTEGER, OPTIONAL, INTENT(IN) :: position
    INTEGER, OPTIONAL, INTENT(IN) :: whalo, ehalo, shalo, nhalo
...
!                       setting complete to .true.
  ...
  SUBROUTINE START_VAR_GROUP_UPDATE_3D(group, group_tl, array, domain, &
&   flags, position, whalo, ehalo, shalo, nhalo, complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
    REAL(fvprc), DIMENSION(:, :, :), INTENT(INOUT) :: array
...
!  Differentiation of start_var_group_update_4d in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edge_m
!od.a2b_ord4 a2b_edge_mod.extrap_corner  dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_
!halo dyn_core_mod.adv_pe dyn_core_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core
!_mod.grad1_p_update dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed fv_dynamics_mod.fv_dynamics fv_dynamics_mod.r
!ayleigh_super fv_dynamics_mod.rayleigh_friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_grid_utils_mod.cubed_
...
!   gradient     of useful results: array
!   with respect to varying inputs: array
  SUBROUTINE START_VAR_GROUP_UPDATE_4D_ADM(group, group_tl, array, &
&   array_ad, domain, flags, position, whalo, ehalo, shalo, nhalo, &
&   complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
...
!                       setting complete to .true.
  ...
  SUBROUTINE START_VAR_GROUP_UPDATE_4D(group, group_tl, array, domain, &
&   flags, position, whalo, ehalo, shalo, nhalo, complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
    REAL(fvprc), DIMENSION(:, :, :, :), INTENT(INOUT) :: array
...
!                       setting complete to .true.
  ...
  SUBROUTINE START_VECTOR_GROUP_UPDATE_2D(group, group_tl, u_cmpt, &
&   v_cmpt, domain, flags, gridtype, whalo, ehalo, shalo, nhalo, &
&   complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
    REAL(fvprc), DIMENSION(:, :), INTENT(INOUT) :: u_cmpt, v_cmpt
...
!  Differentiation of start_vector_group_update_3d in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord2 a2b_edg
...
!   with respect to varying inputs: u_cmpt v_cmpt
  SUBROUTINE START_VECTOR_GROUP_UPDATE_3D_ADM(group, group_tl, u_cmpt, &
&   u_cmpt_ad, v_cmpt, v_cmpt_ad, domain, flags, gridtype, whalo, ehalo&
&   , shalo, nhalo, complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
    REAL(fvprc), DIMENSION(:, :, :), INTENT(INOUT) :: u_cmpt, v_cmpt
    REAL(fvprc), DIMENSION(:, :, :), INTENT(INOUT) :: u_cmpt_ad, &
&   v_cmpt_ad
    TYPE(DOMAIN2D), INTENT(INOUT) :: domain
    INTEGER, OPTIONAL, INTENT(IN) :: flags
    INTEGER, OPTIONAL, INTENT(IN) :: gridtype
...
!                       setting complete to .true.
  ...
  SUBROUTINE START_VECTOR_GROUP_UPDATE_3D(group, group_tl, u_cmpt, &
&   v_cmpt, domain, flags, gridtype, whalo, ehalo, shalo, nhalo, &
&   complete)
    IMPLICIT NONE
    TYPE(GROUP_HALO_UPDATE_TYPE), INTENT(INOUT) :: group, group_tl
