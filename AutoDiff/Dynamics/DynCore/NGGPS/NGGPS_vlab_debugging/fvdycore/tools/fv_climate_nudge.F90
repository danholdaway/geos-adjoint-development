...
character(len=128), parameter :: version = '$Id: fv_climate_nudge.F90,v 1.1.2.1.4.1 2017/02/16 03:47:48 aoloso Exp $'
character(len=128), parameter :: tagname = '$Name: bma_Icarus-3_0_UNSTABLE_FV_R8_NEWLAND $'
