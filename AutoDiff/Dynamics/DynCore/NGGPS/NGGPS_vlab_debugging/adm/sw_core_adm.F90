...
MODULE SW_CORE_MOD_B
  ...
  USE TP_CORE_MOD_B, ONLY : fv_tp_2d, fv_tp_2d_adm, pert_ppm, &
& pert_ppm_adm, copy_corners, copy_corners_adm
  USE FV_MP_MOD_B, ONLY : fill_corners, fill_corners_adm, xdir, ydir
  USE FV_ARRAYS_MOD_B, ONLY : fv_grid_type, fv_grid_bounds_type, &
& fv_flags_type
  USE A2B_EDGE_MOD_B, ONLY : a2b_ord4, a2b_ord4_adm
  IMPLICIT NONE
...
& fill_4corners_bwd, del6_vt_flux_fwd, del6_vt_flux_bwd
  PUBLIC d2a2c_vect
  PUBLIC d2a2c_vect_fwd, d2a2c_vect_bwd
  EXTERNAL D_SW_ADM
  EXTERNAL C_SW_ADM
  EXTERNAL DEL6_VT_FLUX_ADM
  EXTERNAL FILL_4CORNERS_ADM

CONTAINS
!  Differentiation of c_sw in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2b
...
! fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid_u
...
!mpute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_tracer fv_m
!apz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_mod.ppm_p
!rofile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_mod.mois
!t_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_mod.trac
!er_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_utils_mod.
!Riem_Solver3test nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_utils_mod.SI
!M1_solver nh_utils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_mod.c_sw 
!sw_core_mod.d_sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fill3_4cor
!ners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_divergence_dam
!ping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corners tp_c
!ore_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_core_mod.e
!dge_interpolate4)):
!   gradient     of useful results: u v w delp ua uc ptc ut delpc
!                va vc vt wc pt
!   with respect to varying inputs: u v w delp ptc delpc wc pt
...
&         *(ke(i, j-1)-ke(i, j))
    ...
    CALL PUSHINTEGER4(npx)
    CALL PUSHINTEGER4(npy)
    !CALL PUSHPOINTER8(dxc)
    !CALL PUSHPOINTER8(dy)
    CALL PUSHREAL8ARRAY(fy1, (bd%ie-bd%is+3)*(bd%je-bd%js+4))
    CALL PUSHREAL8ARRAY(fy2, (bd%ie-bd%is+3)*(bd%je-bd%js+4))
    !CALL PUSHPOINTER8(cosa_u)
    CALL PUSHINTEGER4(jep1)
    !CALL PUSHPOINTER8(cosa_v)
    CALL PUSHINTEGER4(iep1)
    !CALL PUSHPOINTER8(dyc)
    CALL PUSHINTEGER4(ie)
    !CALL PUSHPOINTER8(sina_u)
    !CALL PUSHPOINTER8(sina_v)
    CALL PUSHINTEGER4(is)
    CALL PUSHREAL8ARRAY(fx, (bd%ie-bd%is+4)*(bd%je-bd%js+3))
    CALL PUSHREAL8ARRAY(fy, (bd%ie-bd%is+3)*(bd%je-bd%js+4))
    CALL PUSHINTEGER4(je)
    CALL PUSHREAL8ARRAY(fx1, (bd%ie-bd%is+4)*(bd%je-bd%js+3))
    CALL PUSHREAL8ARRAY(fx2, (bd%ie-bd%is+4)*(bd%je-bd%js+3))
  END SUBROUTINE C_SW_FWD
!  Differentiation of c_sw in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2
...
!r fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid_
!utils_mod.cubed_to_latlon fv_grid_utils_mod.c2l_ord4 fv_grid_utils_mod.c2l_ord2 fv_mapz_mod.Lagrangian_to_Eulerian fv_mapz_mod.c
!ompute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_tracer fv_
!mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_mod.ppm_
!profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_mod.moi
!st_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_mod.tra
!cer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_utils_mod
!.Riem_Solver3test nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_utils_mod.S
!IM1_solver nh_utils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_mod.c_sw
! sw_core_mod.d_sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fill3_4co
!rners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_divergence_da
!mping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corners tp_
!core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_core_mod.
!edge_interpolate4)):
!   gradient     of useful results: u v w delp ua uc ptc ut delpc
!                va vc vt wc pt
!   with respect to varying inputs: u v w delp ptc delpc wc pt
...
&   va, va_ad, wc, wc_ad, ut, ut_ad, vt, vt_ad, divg_d, nord, dt2, &
&   hydrostatic, dord4, bd, gridstruct, flagstruct)
    IMPLICIT NONE
    TYPE(FV_GRID_BOUNDS_TYPE), INTENT(IN) :: bd
    REAL, DIMENSION(bd%isd:bd%ied, bd%jsd:bd%jed+1), INTENT(INOUT) :: u&
&   , vc
...
&   divg_d
    ...
    LOGICAL :: sw_corner, se_corner, ne_corner, nw_corner
    REAL, DIMENSION(bd%is-1:bd%ie+1, bd%js-1:bd%je+1) :: vort, ke
    REAL, DIMENSION(bd%is-1:bd%ie+1, bd%js-1:bd%je+1) :: vort_ad
    REAL, DIMENSION(bd%is-1:bd%ie+2, bd%js-1:bd%je+1) :: fx, fx1, fx2
...
&   fy2_ad
    ...
    CALL POPREAL8ARRAY(fx2, (bd%ie-bd%is+4)*(bd%je-bd%js+3))
    CALL POPREAL8ARRAY(fx1, (bd%ie-bd%is+4)*(bd%je-bd%js+3))
    CALL POPINTEGER4(je)
    CALL POPREAL8ARRAY(fy, (bd%ie-bd%is+3)*(bd%je-bd%js+4))
    CALL POPREAL8ARRAY(fx, (bd%ie-bd%is+4)*(bd%je-bd%js+3))
    CALL POPINTEGER4(is)
    sina_v => gridstruct%sina_v
    !CALL ADMM_REBASE(sina_v)
    sina_u => gridstruct%sina_u
    !CALL ADMM_REBASE(sina_u)
    CALL POPINTEGER4(ie)
    dyc => gridstruct%dyc
    !CALL ADMM_REBASE(dyc)
    CALL POPINTEGER4(iep1)
    cosa_v => gridstruct%cosa_v
    !CALL ADMM_REBASE(cosa_v)
    CALL POPINTEGER4(jep1)
    cosa_u => gridstruct%cosa_u
    !CALL ADMM_REBASE(cosa_u)
    CALL POPREAL8ARRAY(fy2, (bd%ie-bd%is+3)*(bd%je-bd%js+4))
    CALL POPREAL8ARRAY(fy1, (bd%ie-bd%is+3)*(bd%je-bd%js+4))
    dy => gridstruct%dy
    !CALL ADMM_REBASE(dy)
    dxc => gridstruct%dxc
    !CALL ADMM_REBASE(dxc)
    CALL POPINTEGER4(npy)
    CALL POPINTEGER4(npx)
    CALL POPINTEGER4(js)
    fx_ad = 0.0_8
    fx1_ad = 0.0_8
    DO j=jep1,js,-1
    ...
    IF (branch .EQ. 0) THEN
      ...
      DO j=jep1,js,-1
        ...
        IF (branch .EQ. 0) THEN
          DO i=ie,is,-1
            ...
            temp_ad10 = dt2*fx1_ad(i, j)/sina_v(i, j)
            u_ad(i, j) = u_ad(i, j) + temp_ad10
            vc_ad(i, j) = vc_ad(i, j) - cosa_v(i, j)*temp_ad10
            fx1_ad(i, j) = 0.0_8
          END DO
        ELSE
          DO i=ie,is,-1
      ...
      DO j=je,js,-1
        DO i=iep1,is,-1
          ...
          ELSE
            CALL POPREAL8(fy1(i, j))
            temp_ad9 = dt2*fy1_ad(i, j)/sina_u(i, j)
            v_ad(i, j) = v_ad(i, j) + temp_ad9
            uc_ad(i, j) = uc_ad(i, j) - cosa_u(i, j)*temp_ad9
            fy1_ad(i, j) = 0.0_8
          END IF
        END DO
      END DO
    ...
    END DO
    CALL POPCONTROL1B(branch)
    IF (branch .NE. 0) fy_ad(0, npy) = fy_ad(0, npy) + vort_ad(1, npy)
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) fy_ad(npx, npy) = fy_ad(npx, npy) - vort_ad(npx, &
&       npy)
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) fy_ad(npx, 1) = fy_ad(npx, 1) - vort_ad(npx, 1)
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) fy_ad(0, 1) = fy_ad(0, 1) + vort_ad(1, 1)
    DO j=je+1,js,-1
      DO i=ie+1,is,-1
...
&         *(ke(i, j-1)-ke(i, j))
    ...
    END DO
  END SUBROUTINE C_SW
!  Differentiation of d_sw in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2b
!_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core_mod.p_
!grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.mix_dp 
!dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayleigh_Super
! fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid_u
...
&   q_con, z_rat, kgb, heat_source, zvir, sphum, nq, q, k, km, inline_q&
...
! flagstruct%grid_type >= 3
    ...
    DO j=jsd,jed
      DO i=is,ie+1
        CALL PUSHREAL8(xfx_adv(i, j))
        xfx_adv(i, j) = dt*ut(i, j)
      END DO
    END DO
    DO j=js,je+1
      DO i=isd,ied
        CALL PUSHREAL8(yfx_adv(i, j))
...
&                 =nord_v, damp_c=damp_v)
      CALL PUSHCONTROL1B(1)
    ELSE
      CALL FV_TP_2D_FWD(delp, crx_adv, cry_adv, npx, npy, hord_dp_pert, &
&                 fx, fy, xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y, &
&                 nord=nord_v_pert, damp_c=damp_v_pert)
      CALL PUSHCONTROL1B(0)
    END IF
! <<< Save the mass fluxes to the "Flux Capacitor" for tracer transport >>>
    ...
    IF (.NOT.hydrostatic) THEN
      IF (damp_w .GT. 1.e-5) THEN
        ...
        CALL DEL6_VT_FLUX_FWD(nord_w, npx, npy, damp4, w, wk, fx2, fy2, &
&                       gridstruct, bd)
        DO j=js,je
          DO i=is,ie
...
!                   heat_source(i,j) = -d_con*dw(i,j)*(w(i,j)+0.5*dw(i,j))
      ...
      IF (hord_vt .EQ. hord_vt_pert) THEN
        CALL FV_TP_2D_FWD(w, crx_adv, cry_adv, npx, npy, hord_vt, gx, gy&
&                   , xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y, mfx=&
&                   fx, mfy=fy)
        CALL PUSHCONTROL1B(1)
      ELSE
        CALL FV_TP_2D_FWD(w, crx_adv, cry_adv, npx, npy, hord_vt_pert, &
&                   gx, gy, xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y&
&                   , mfx=fx, mfy=fy)
        CALL PUSHCONTROL1B(0)
      END IF
      DO j=js,je
...
!    endif
    IF (hord_tm .EQ. hord_tm_pert .AND. (.NOT.split_damp)) THEN
      CALL FV_TP_2D_FWD(pt, crx_adv, cry_adv, npx, npy, hord_tm, gx, gy&
&                 , xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y, mfx=fx&
&                 , mfy=fy, mass=delp, nord=nord_t, damp_c=damp_t)
      CALL PUSHCONTROL1B(0)
    ELSE
      CALL FV_TP_2D_FWD(pt, crx_adv, cry_adv, npx, npy, hord_tm_pert, gx&
&                 , gy, xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y, &
&                 mfx=fx, mfy=fy, mass=delp, nord=nord_t_pert, damp_c=&
&                 damp_t_pert)
      CALL PUSHCONTROL1B(1)
    END IF
    IF (inline_q) THEN
...
&           (i, j+1))*rarea(i, j))/delp(i, j)
      ...
      DO iq=1,nq
        IF (hord_tr .EQ. hord_tr_pert) THEN
          CALL FV_TP_2D_FWD(q(isd:ied, jsd:jed, k, iq), crx_adv, cry_adv&
&                     , npx, npy, hord_tr, gx, gy, xfx_adv, yfx_adv, &
&                     gridstruct, bd, ra_x, ra_y, mfx=fx, mfy=fy, mass=&
&                     delp, nord=nord_t, damp_c=damp_t)
          CALL PUSHCONTROL1B(1)
        ELSE
          CALL FV_TP_2D_FWD(q(isd:ied, jsd:jed, k, iq), crx_adv, cry_adv&
&                     , npx, npy, hord_tr_pert, gx, gy, xfx_adv, yfx_adv&
&                     , gridstruct, bd, ra_x, ra_y, mfx=fx, mfy=fy, mass&
&                     =delp, nord=nord_t_pert, damp_c=damp_t_pert)
          CALL PUSHCONTROL1B(0)
        END IF
        DO j=js,je
          DO i=is,ie
...
&              flagstruct%grid_type, nested)
    ...
    ELSE
      CALL YTP_V_FWD(is, ie, js, je, isd, ied, jsd, jed, vb, u, v, ub, &
&              hord_mt_pert, gridstruct%dy, gridstruct%rdy, npx, npy, &
&              flagstruct%grid_type, nested)
      CALL PUSHCONTROL1B(0)
    END IF
    DO j=js,je+1
...
&              flagstruct%grid_type, nested)
    ...
    ELSE
      CALL XTP_U_FWD(is, ie, js, je, isd, ied, jsd, jed, ub, u, v, vb, &
&              hord_mt_pert, gridstruct%dx, gridstruct%rdx, npx, npy, &
&              flagstruct%grid_type, nested)
      CALL PUSHCONTROL1B(0)
    END IF
    DO j=js,je+1
...
!   endif
    IF (.NOT.split_damp) THEN
      CALL COMPUTE_DIVERGENCE_DAMPING_FWD(nord, d2_bg, d4_bg, dddmp, dt&
&                                   , vort, ptc, delpc, ke, u, v, uc, vc&
&                                   , ua, va, divg_d, wk, gridstruct, &
&                                   flagstruct, bd)
      CALL PUSHCONTROL1B(0)
    ELSE
      CALL COMPUTE_DIVERGENCE_DAMPING_FWD(nord_pert, d2_bg_pert, &
&                                   d4_bg_pert, dddmp_pert, dt, vort, &
&                                   ptc, delpc, ke, u, v, uc, vc, ua, va&
&                                   , divg_d, wk, gridstruct, flagstruct&
&                                   , bd)
      CALL PUSHCONTROL1B(1)
    END IF
...
&                 fy, xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y)
      CALL PUSHCONTROL1B(1)
    ELSE
      CALL FV_TP_2D_FWD(vort, crx_adv, cry_adv, npx, npy, hord_vt_pert, &
&                 fx, fy, xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y)
      CALL PUSHCONTROL1B(0)
    END IF
    DO j=js,je+1
      DO i=is,ie
        CALL PUSHREAL8(u(i, j))
        u(i, j) = vt(i, j) + ke(i, j) - ke(i+1, j) + fy(i, j)
      END DO
    END DO
    DO j=js,je
      DO i=is,ie+1
        CALL PUSHREAL8(v(i, j))
...
! damping applied to relative vorticity (wk):
    IF (damp_v .GT. 1.e-5) THEN
      ...
      CALL DEL6_VT_FLUX_FWD(nord_v, npx, npy, damp4, wk, vort, ut, vt, &
&                     gridstruct, bd)
      CALL PUSHCONTROL1B(0)
    ELSE
      CALL PUSHCONTROL1B(1)
...
! Convert lost KE due to divergence damping to "heat"
          CALL PUSHREAL8(heat_source(i, j))
...
! Add diffusive fluxes to the momentum equation:
    IF (damp_v .GT. 1.e-5) THEN
      ...
      CALL PUSHINTEGER4(max2)
      CALL PUSHINTEGER4(max3)
      CALL PUSHINTEGER4(max4)
      CALL PUSHREAL8(damp)
      CALL PUSHREAL8ARRAY(gx, (bd%ie-bd%is+2)*(bd%je-bd%js+1))
      CALL PUSHREAL8ARRAY(gy, (bd%ie-bd%is+1)*(bd%je-bd%js+2))
      CALL PUSHREAL8ARRAY(dw, (bd%ie-bd%is+1)*(bd%je-bd%js+1))
      !CALL PUSHPOINTER8(dx)
      CALL PUSHINTEGER4(is2)
      !CALL PUSHPOINTER8(dy)
      !CALL PUSHPOINTER8(rdya)
      CALL PUSHREAL8ARRAY(ub, (bd%ie-bd%is+2)*(bd%je-bd%js+2))
      !CALL PUSHPOINTER8(cosa_u)
      !CALL PUSHPOINTER8(cosa_v)
      !CALL PUSHPOINTER8(cosa)
      CALL PUSHREAL8ARRAY(ut, (bd%ied-bd%isd+2)*(bd%jed-bd%jsd+1))
      CALL PUSHINTEGER4(je1)
      !CALL PUSHPOINTER8(sin_sg)
      CALL PUSHREAL8(dt4)
      CALL PUSHREAL8(dt6)
      CALL PUSHINTEGER4(ie)
      CALL PUSHREAL8ARRAY(ra_x, (bd%ie-bd%is+1)*(bd%jed-bd%jsd+1))
      CALL PUSHREAL8ARRAY(vb, (bd%ie-bd%is+2)*(bd%je-bd%js+2))
      CALL PUSHREAL8ARRAY(ra_y, (bd%ied-bd%isd+1)*(bd%je-bd%js+1))
      CALL PUSHREAL8ARRAY(vort, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
      !CALL PUSHPOINTER8(rsin_u)
      CALL PUSHINTEGER4(is)
      !CALL PUSHPOINTER8(rsina)
      !CALL PUSHPOINTER8(rdx)
      CALL PUSHREAL8ARRAY(vt, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+2))
      CALL PUSHINTEGER4(js2)
      CALL PUSHREAL8ARRAY(fx, (bd%ie-bd%is+2)*(bd%je-bd%js+1))
      CALL PUSHINTEGER4(min1)
      CALL PUSHREAL8ARRAY(fy, (bd%ie-bd%is+1)*(bd%je-bd%js+2))
      CALL PUSHINTEGER4(min2)
      CALL PUSHINTEGER4(min3)
      CALL PUSHINTEGER4(ie1)
      CALL PUSHINTEGER4(min4)
      CALL PUSHINTEGER4(je)
      !CALL PUSHPOINTER8(rdxa)
      CALL PUSHREAL8ARRAY(wk, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
      CALL PUSHCONTROL1B(1)
    ELSE
      CALL PUSHINTEGER4(js)
      CALL PUSHINTEGER4(npx)
...
!  Differentiation of d_sw in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2
!b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core_mod.p
!_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.mix_dp
! dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayleigh_Supe
!r fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid_
...
&   heat_source, heat_source_ad, zvir, sphum, nq, q, q_ad, k, km, &
...
&   delp_ad, pt_ad, ua_ad, va_ad
    REAL, DIMENSION(bd%isd:bd%ied, bd%jsd:bd%ied), INTENT(INOUT) :: w
    REAL, DIMENSION(bd%isd:bd%ied, bd%jsd:bd%ied), INTENT(INOUT) :: w_ad
    REAL, DIMENSION(bd%isd:bd%isd, bd%jsd:bd%isd), INTENT(INOUT) :: &
&   q_con
    REAL, DIMENSION(bd%isd:bd%ied, bd%jsd:bd%jed+1), INTENT(INOUT) :: u&
&   , vc
...
&   , rdx, rdy
    ...
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) THEN
      CALL POPREAL8ARRAY(wk, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
      rdxa => gridstruct%rdxa
      !CALL ADMM_REBASE(rdxa)
      CALL POPINTEGER4(je)
      CALL POPINTEGER4(min4)
      CALL POPINTEGER4(ie1)
      CALL POPINTEGER4(min3)
      CALL POPINTEGER4(min2)
      CALL POPREAL8ARRAY(fy, (bd%ie-bd%is+1)*(bd%je-bd%js+2))
      CALL POPINTEGER4(min1)
      CALL POPREAL8ARRAY(fx, (bd%ie-bd%is+2)*(bd%je-bd%js+1))
      CALL POPINTEGER4(js2)
      CALL POPREAL8ARRAY(vt, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+2))
      rdx => gridstruct%rdx
      !CALL ADMM_REBASE(rdx)
      rsina => gridstruct%rsina
      !CALL ADMM_REBASE(rsina)
      CALL POPINTEGER4(is)
      rsin_u => gridstruct%rsin_u
      !CALL ADMM_REBASE(rsin_u)
      CALL POPREAL8ARRAY(vort, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
      CALL POPREAL8ARRAY(ra_y, (bd%ied-bd%isd+1)*(bd%je-bd%js+1))
      CALL POPREAL8ARRAY(vb, (bd%ie-bd%is+2)*(bd%je-bd%js+2))
      CALL POPREAL8ARRAY(ra_x, (bd%ie-bd%is+1)*(bd%jed-bd%jsd+1))
      CALL POPINTEGER4(ie)
      CALL POPREAL8(dt6)
      CALL POPREAL8(dt4)
      sin_sg => gridstruct%sin_sg
      !CALL ADMM_REBASE(sin_sg)
      CALL POPINTEGER4(je1)
      CALL POPREAL8ARRAY(ut, (bd%ied-bd%isd+2)*(bd%jed-bd%jsd+1))
      cosa => gridstruct%cosa
      !CALL ADMM_REBASE(cosa)
      cosa_v => gridstruct%cosa_v
      !CALL ADMM_REBASE(cosa_v)
      cosa_u => gridstruct%cosa_u
      !CALL ADMM_REBASE(cosa_u)
      CALL POPREAL8ARRAY(ub, (bd%ie-bd%is+2)*(bd%je-bd%js+2))
      rdya => gridstruct%rdya
      !CALL ADMM_REBASE(rdya)
      dy => gridstruct%dy
      !CALL ADMM_REBASE(dy)
      CALL POPINTEGER4(is2)
      dx => gridstruct%dx
      !CALL ADMM_REBASE(dx)
      CALL POPREAL8ARRAY(dw, (bd%ie-bd%is+1)*(bd%je-bd%js+1))
      CALL POPREAL8ARRAY(gy, (bd%ie-bd%is+1)*(bd%je-bd%js+2))
      CALL POPREAL8ARRAY(gx, (bd%ie-bd%is+2)*(bd%je-bd%js+1))
      CALL POPREAL8(damp)
      CALL POPINTEGER4(max4)
      CALL POPINTEGER4(max3)
      CALL POPINTEGER4(max2)
    ...
    IF (branch .EQ. 0) THEN
      ...
      DO j=je,js,-1
        DO i=ie,is,-1
          ...
          du2 = ub(i, j) + ub(i, j+1)
          u2 = fy(i, j) + fy(i, j+1)
          CALL POPREAL8(heat_source(i, j))
          temp0 = damp*rsin2(i, j)
          temp_ad87 = delp(i, j)*heat_source_ad(i, j)
          temp_ad88 = -(temp0*temp_ad87)
...
&           +du2*dv2)))*heat_source_ad(i, j)
      ...
      DO j=je,js,-1
        DO i=ie+1,is,-1
          ...
          temp_ad86 = rdy(i, j)*vb_ad(i, j)
          ut_ad(i, j) = ut_ad(i, j) - temp_ad86
          vb_ad(i, j) = temp_ad86
        END DO
      END DO
      DO j=je+1,js,-1
        DO i=ie,is,-1
          CALL POPREAL8(gy(i, j))
          ...
          temp_ad85 = rdx(i, j)*ub_ad(i, j)
          vt_ad(i, j) = vt_ad(i, j) + temp_ad85
          ub_ad(i, j) = temp_ad85
        END DO
      END DO
    ELSE
    ...
    IF (branch .EQ. 0) THEN
      ...
      wk_ad = 0.0_8
      vort_ad = 0.0_8
      CALL DEL6_VT_FLUX_BWD(nord_v, npx, npy, damp4, wk, wk_ad, vort, &
...
&                 xfx_adv, xfx_adv_ad, yfx_adv, yfx_adv_ad, gridstruct, &
&                 bd, ra_x, ra_x_ad, ra_y, ra_y_ad)
    END IF
    f0 => gridstruct%f0
    jsd = bd%jsd
    ied = bd%ied
    ...
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) THEN
      CALL COMPUTE_DIVERGENCE_DAMPING_BWD(nord, d2_bg, d4_bg, dddmp, dt&
...
&                                   , bd)
    ELSE
      CALL COMPUTE_DIVERGENCE_DAMPING_BWD(nord_pert, d2_bg_pert, &
&                                   d4_bg_pert, dddmp_pert, dt, vort, &
...
&                                   , bd)
    ...
    IF (branch .NE. 0) THEN
      DO j=je,js,-1
        DO i=ie,is,-1
          CALL POPREAL8(w(i, j))
          temp_ad84 = w_ad(i, j)/delp(i, j)
          delp_ad(i, j) = delp_ad(i, j) - w(i, j)*temp_ad84/delp(i, j)
          w_ad(i, j) = temp_ad84
        END DO
      END DO
    END IF
 100 rarea => gridstruct%rarea
    DO j=jed,jsd,-1
      DO i=ied,isd,-1
        ...
        temp_ad83 = rarea(i, j)*wk_ad(i, j)
        vt_ad(i, j) = vt_ad(i, j) + temp_ad83
        vt_ad(i, j+1) = vt_ad(i, j+1) - temp_ad83
        ut_ad(i+1, j) = ut_ad(i+1, j) + temp_ad83
        ut_ad(i, j) = ut_ad(i, j) - temp_ad83
        wk_ad(i, j) = 0.0_8
      END DO
    END DO
    DO j=jed,jsd,-1
    ...
    IF (branch .NE. 0) THEN
      IF (branch .NE. 1) THEN
        dt6 = dt/6.
        temp_ad79 = dt6*ke_ad(1, npy)
        temp_ad80 = u(1, npy)*temp_ad79
        temp_ad81 = v(1, npy-1)*temp_ad79
        temp_ad82 = u(0, npy)*temp_ad79
        ut_ad(1, npy) = ut_ad(1, npy) + temp_ad80
        ut_ad(1, npy-1) = ut_ad(1, npy-1) + temp_ad82 + temp_ad80
        u_ad(1, npy) = u_ad(1, npy) + (ut(1, npy)+ut(1, npy-1))*&
&         temp_ad79
        vt_ad(1, npy) = vt_ad(1, npy) + temp_ad81 - temp_ad82
        vt_ad(0, npy) = vt_ad(0, npy) + temp_ad81
...
&         temp_ad79
      ...
      CALL POPCONTROL1B(branch)
      IF (branch .EQ. 0) THEN
        temp_ad75 = dt6*ke_ad(npx, npy)
        temp_ad76 = u(npx-1, npy)*temp_ad75
        temp_ad77 = v(npx, npy-1)*temp_ad75
        temp_ad78 = u(npx, npy)*temp_ad75
        ut_ad(npx, npy) = ut_ad(npx, npy) + temp_ad76
        ut_ad(npx, npy-1) = ut_ad(npx, npy-1) + temp_ad78 + temp_ad76
        u_ad(npx-1, npy) = u_ad(npx-1, npy) + (ut(npx, npy)+ut(npx, npy-&
&         1))*temp_ad75
        vt_ad(npx, npy) = vt_ad(npx, npy) + temp_ad77
        vt_ad(npx-1, npy) = vt_ad(npx-1, npy) + temp_ad78 + temp_ad77
...
&         )*temp_ad75
      ...
      CALL POPCONTROL1B(branch)
      IF (branch .EQ. 0) THEN
        temp_ad71 = dt6*ke_ad(npx, 1)
        temp_ad72 = u(npx-1, 1)*temp_ad71
        temp_ad73 = v(npx, 1)*temp_ad71
        temp_ad74 = u(npx, 1)*temp_ad71
        ut_ad(npx, 1) = ut_ad(npx, 1) + temp_ad74 + temp_ad72
        ut_ad(npx, 0) = ut_ad(npx, 0) + temp_ad72
        u_ad(npx-1, 1) = u_ad(npx-1, 1) + (ut(npx, 1)+ut(npx, 0))*&
&         temp_ad71
        vt_ad(npx, 1) = vt_ad(npx, 1) + temp_ad73
        vt_ad(npx-1, 1) = vt_ad(npx-1, 1) + temp_ad73 - temp_ad74
...
&         temp_ad71
      ...
      CALL POPCONTROL1B(branch)
      IF (branch .EQ. 0) THEN
        temp_ad70 = dt6*ke_ad(1, 1)
        ut_ad(1, 1) = ut_ad(1, 1) + (u(0, 1)+u(1, 1))*temp_ad70
        ut_ad(1, 0) = ut_ad(1, 0) + u(1, 1)*temp_ad70
        u_ad(1, 1) = u_ad(1, 1) + (ut(1, 1)+ut(1, 0))*temp_ad70
        vt_ad(1, 1) = vt_ad(1, 1) + (u(0, 1)+v(1, 1))*temp_ad70
        vt_ad(0, 1) = vt_ad(0, 1) + v(1, 1)*temp_ad70
        v_ad(1, 1) = v_ad(1, 1) + (vt(1, 1)+vt(0, 1))*temp_ad70
        u_ad(0, 1) = u_ad(0, 1) + (ut(1, 1)+vt(1, 1))*temp_ad70
        ke_ad(1, 1) = 0.0_8
      END IF
    END IF
    DO j=je+1,js,-1
      DO i=ie+1,is,-1
        temp_ad69 = 0.5*ke_ad(i, j)
        ub_ad(i, j) = ub_ad(i, j) + vb(i, j)*temp_ad69
        vb_ad(i, j) = vb_ad(i, j) + ub(i, j)*temp_ad69
        ke_ad(i, j) = temp_ad69
      END DO
    END DO
    CALL POPCONTROL1B(branch)
...
&              gridstruct%rdx, npx, npy, flagstruct%grid_type, nested)
    ELSE
      CALL XTP_U_BWD(is, ie, js, je, isd, ied, jsd, jed, ub, ub_ad, u, &
&              u_ad, v, vb, vb_ad, hord_mt, gridstruct%dx, gridstruct%&
&              rdx, npx, npy, flagstruct%grid_type, nested)
    END IF
    dt5 = 0.5*dt
    CALL POPCONTROL2B(branch)
    IF (branch .LT. 2) THEN
      IF (branch .EQ. 0) THEN
        DO j=je+1,js,-1
          DO i=ie1,is2,-1
            CALL POPREAL8(ub(i, j))
            temp_ad64 = dt5*rsina(i, j)*ub_ad(i, j)
            temp_ad65 = -(cosa(i, j)*temp_ad64)
    ...
    DO j=je+1,js,-1
      ...
      IF (branch .EQ. 0) THEN
        DO i=ie1,is2,-1
          CALL POPREAL8(ub(i, j))
          temp_ad67 = dt5*rsina(i, j)*ub_ad(i, j)
          temp_ad68 = -(cosa(i, j)*temp_ad67)
          uc_ad(i, j-1) = uc_ad(i, j-1) + temp_ad67
          uc_ad(i, j) = uc_ad(i, j) + temp_ad67
          vc_ad(i-1, j) = vc_ad(i-1, j) + temp_ad68
          vc_ad(i, j) = vc_ad(i, j) + temp_ad68
          ub_ad(i, j) = 0.0_8
        END DO
      ELSE
        DO i=ie1,is2,-1
          CALL POPREAL8(ub(i, j))
          temp_ad66 = dt4*ub_ad(i, j)
          ut_ad(i, j-1) = ut_ad(i, j-1) + 3.*temp_ad66
          ut_ad(i, j) = ut_ad(i, j) + 3.*temp_ad66
          ut_ad(i, j-2) = ut_ad(i, j-2) - temp_ad66
          ut_ad(i, j+1) = ut_ad(i, j+1) - temp_ad66
          ub_ad(i, j) = 0.0_8
        END DO
      END IF
    END DO
 ...
 110 DO j=je+1,js,-1
    ...
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) THEN
      CALL YTP_V_BWD(is, ie, js, je, isd, ied, jsd, jed, vb, vb_ad, u, v&
&              , v_ad, ub, ub_ad, hord_mt_pert, gridstruct%dy, &
&              gridstruct%rdy, npx, npy, flagstruct%grid_type, nested)
    ELSE
      CALL YTP_V_BWD(is, ie, js, je, isd, ied, jsd, jed, vb, vb_ad, u, v&
&              , v_ad, ub, ub_ad, hord_mt, gridstruct%dy, gridstruct%rdy&
&              , npx, npy, flagstruct%grid_type, nested)
    ...
    IF (branch .LT. 2) THEN
      IF (branch .EQ. 0) THEN
        DO j=je1,js2,-1
          DO i=ie1,is2,-1
            temp_ad58 = dt5*rsina(i, j)*vb_ad(i, j)
            temp_ad59 = -(cosa(i, j)*temp_ad58)
            vc_ad(i-1, j) = vc_ad(i-1, j) + temp_ad58
            vc_ad(i, j) = vc_ad(i, j) + temp_ad58
    ...
    DO j=je1,js2,-1
      CALL POPCONTROL1B(branch)
      IF (branch .NE. 0) THEN
        temp_ad63 = dt4*vb_ad(npx, j)
        vt_ad(npx-1, j) = vt_ad(npx-1, j) + 3.*temp_ad63
        vt_ad(npx, j) = vt_ad(npx, j) + 3.*temp_ad63
        vt_ad(npx-2, j) = vt_ad(npx-2, j) - temp_ad63
        vt_ad(npx+1, j) = vt_ad(npx+1, j) - temp_ad63
        vb_ad(npx, j) = 0.0_8
      END IF
      CALL POPCONTROL1B(branch)
      IF (branch .EQ. 0) THEN
        temp_ad62 = dt4*vb_ad(1, j)
        vt_ad(0, j) = vt_ad(0, j) + 3.*temp_ad62
        vt_ad(1, j) = vt_ad(1, j) + 3.*temp_ad62
        vt_ad(-1, j) = vt_ad(-1, j) - temp_ad62
        vt_ad(2, j) = vt_ad(2, j) - temp_ad62
        vb_ad(1, j) = 0.0_8
      END IF
      DO i=ie1,is2,-1
        temp_ad60 = dt5*rsina(i, j)*vb_ad(i, j)
        temp_ad61 = -(cosa(i, j)*temp_ad60)
...
&                     , gridstruct, bd, ra_x, ra_x_ad, ra_y, ra_y_ad, &
&                     mfx=fx, mfx=fx_ad, mfy=fy, mfy=fy_ad, mass=delp, &
&                     mass=delp_ad, nord=nord_t_pert, damp_c=damp_t_pert&
&                    )
        ELSE
          CALL FV_TP_2D_BWD(q(isd:ied, jsd:jed, k, iq), q_ad(isd:ied, &
&                     jsd:jed, k, iq), crx_adv, crx_adv_ad, cry_adv, &
...
&                 xfx_adv, xfx_adv_ad, yfx_adv, yfx_adv_ad, gridstruct, &
&                 bd, ra_x, ra_x_ad, ra_y, ra_y_ad, mfx=fx, mfx=fx_ad, &
&                 mfy=fy, mfy=fy_ad, mass=delp, mass=delp_ad, nord=&
&                 nord_t, damp_c=damp_t)
    ELSE
      CALL FV_TP_2D_BWD(pt, pt_ad, crx_adv, crx_adv_ad, cry_adv, &
&                 cry_adv_ad, npx, npy, hord_tm_pert, gx, gx_ad, gy, &
&                 gy_ad, xfx_adv, xfx_adv_ad, yfx_adv, yfx_adv_ad, &
&                 gridstruct, bd, ra_x, ra_x_ad, ra_y, ra_y_ad, mfx=fx, &
&                 mfx=fx_ad, mfy=fy, mfy=fy_ad, mass=delp, mass=delp_ad&
&                 , nord=nord_t_pert, damp_c=damp_t_pert)
    END IF
    CALL POPCONTROL1B(branch)
    IF (branch .EQ. 0) THEN
      DO j=je,js,-1
...
&                   gy_ad, xfx_adv, xfx_adv_ad, yfx_adv, yfx_adv_ad, &
&                   gridstruct, bd, ra_x, ra_x_ad, ra_y, ra_y_ad, mfx=fx&
&                   , mfx=fx_ad, mfy=fy, mfy=fy_ad)
      ELSE
        CALL FV_TP_2D_BWD(w, w_ad, crx_adv, crx_adv_ad, cry_adv, &
&                   cry_adv_ad, npx, npy, hord_vt, gx, gx_ad, gy, gy_ad&
...
&             i, j))*heat_source_ad(i, j)
        ...
        END DO
        damp4 = (damp_w*gridstruct%da_min_c)**(nord_w+1)
        CALL DEL6_VT_FLUX_BWD(nord_w, npx, npy, damp4, w, w_ad, wk, &
...
&                 xfx_adv, xfx_adv_ad, yfx_adv, yfx_adv_ad, gridstruct, &
&                 bd, ra_x, ra_x_ad, ra_y, ra_y_ad, nord=nord_v, damp_c=&
&                 damp_v)
    END IF
    DO j=je,js,-1
      DO i=ied,isd,-1
...
&             xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y, nord=nord_v&
&             , damp_c=damp_v)
    ELSE
...
&             xfx_adv, yfx_adv, gridstruct, bd, ra_x, ra_y, fx, fy, delp&
&             , nord_t, damp_t)
    ELSE
...
&                 damp_t)
        ELSE
          CALL FV_TP_2D(q(isd:ied, jsd:jed, k, iq), crx_adv, cry_adv, &
&                 npx, npy, hord_tr_pert, gx, gy, xfx_adv, yfx_adv, &
&                 gridstruct, bd, ra_x, ra_y, fx, fy, delp, nord_t_pert&
&                 , damp_t_pert)
        END IF
        DO j=js,je
          DO i=is,ie
...
&          hord_mt, gridstruct%dy, gridstruct%rdy, npx, npy, flagstruct%&
&          grid_type, nested)
    ELSE
      CALL YTP_V(is, ie, js, je, isd, ied, jsd, jed, vb, u, v, ub, &
&          hord_mt_pert, gridstruct%dy, gridstruct%rdy, npx, npy, &
...
&          hord_mt, gridstruct%dx, gridstruct%rdx, npx, npy, flagstruct%&
&          grid_type, nested)
    ELSE
      CALL XTP_U(is, ie, js, je, isd, ied, jsd, jed, ub, u, v, vb, &
&          hord_mt_pert, gridstruct%dx, gridstruct%rdx, npx, npy, &
...
&                               bd)
    ELSE
      CALL COMPUTE_DIVERGENCE_DAMPING(nord_pert, d2_bg_pert, d4_bg_pert&
&                               , dddmp_pert, dt, vort, ptc, delpc, ke, &
...
! Add diffusive fluxes to the momentum equation:
    ...
    END IF
  END SUBROUTINE D_SW
!  Differentiation of del6_vt_flux in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge
...
!z_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_tra
!cer fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_m
!od.ppm_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_
!mod.moist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_
!mod.tracer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_ut
!ils_mod.Riem_Solver3test nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_util
!s_mod.SIM1_solver nh_utils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_m
!od.c_sw sw_core_mod.d_sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fi
!ll3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_diverg
!ence_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corn
!ers tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_co
!re_mod.edge_interpolate4)):
!   gradient     of useful results: q fy2 d2 fx2
!   with respect to varying inputs: q fy2 d2 fx2
  SUBROUTINE DEL6_VT_FLUX_FWD(nord, npx, npy, damp, q, d2, fx2, fy2, &
&   gridstruct, bd)
    IMPLICIT NONE
...
&   jsd:bd%jed+1)
    ...
    DO j=j1,j2
      DO i=i1,i2
        CALL PUSHREAL8(d2(i, j))
        d2(i, j) = damp*q(i, j)
      END DO
    END DO
    IF (nord .GT. 0) THEN
      CALL COPY_CORNERS_FWD(d2, npx, npy, 1, nested, bd, gridstruct%&
...
&                     nw_corner, gridstruct%ne_corner)
    ...
    END DO
    IF (nord .GT. 0) THEN
      CALL COPY_CORNERS_FWD(d2, npx, npy, 2, nested, bd, gridstruct%&
&                     sw_corner, gridstruct%se_corner, gridstruct%&
&                     nw_corner, gridstruct%ne_corner)
      CALL PUSHCONTROL1B(1)
    ELSE
...
&                       nw_corner, gridstruct%ne_corner)
    ...
    ELSE
      ...
      CALL PUSHCONTROL1B(0)
    END IF
  END SUBROUTINE DEL6_VT_FLUX_FWD
!  Differentiation of del6_vt_flux in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edg
...
!   gradient     of useful results: q fy2 d2 fx2
!   with respect to varying inputs: q fy2 d2 fx2
  SUBROUTINE DEL6_VT_FLUX_BWD(nord, npx, npy, damp, q, q_ad, d2, d2_ad, &
    ...
    ELSE
      ...
      DO n=nord,1,-1
        ...
        DO j=ad_to4,ad_from4,-1
          ...
          END DO
        END DO
        CALL COPY_CORNERS_BWD(d2, d2_ad, npx, npy, 2, nested, bd, &
...
&                       gridstruct%nw_corner, gridstruct%ne_corner)
        ...
        DO j=ad_to2,ad_from2,-1
          ...
          END DO
        END DO
        CALL COPY_CORNERS_BWD(d2, d2_ad, npx, npy, 1, nested, bd, &
&                       gridstruct%sw_corner, gridstruct%se_corner, &
&                       gridstruct%nw_corner, gridstruct%ne_corner)
...
&                                      ne_corner)
    ...
    DO j=j2,j1,-1
      ...
      END DO
    END DO
  END SUBROUTINE DEL6_VT_FLUX_BWD
...
!  Differentiation of xtp_u in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2
!b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core_mod.p
!_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.mix_dp
! dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayleigh_Supe
!r fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid_
...
!   with respect to varying inputs: flux u c
  SUBROUTINE XTP_U_FWD(is, ie, js, je, isd, ied, jsd, jed, c, u, v, flux&
...
!  iord=5,6,7
      ...
      CALL PUSHREAL8ARRAY(bl, ie - is + 3)
      CALL PUSHREAL8ARRAY(br, ie - is + 3)
      CALL PUSHREAL8(min1)
      CALL PUSHREAL8(min2)
      CALL PUSHREAL8ARRAY(b0, ie - is + 3)
      CALL PUSHINTEGER4(ie3)
      CALL PUSHREAL8ARRAY(fx0, ie - is + 2)
      CALL PUSHCONTROL2B(1)
    ELSE
! iord = 8, 9, 10, 11
      DO j=js,je+1
...
&               )/(dx(1, j)+dx(2, j))
              ...
              CALL PUSHCONTROL1B(1)
            END IF
            CALL PUSHREAL8ARRAY(br(2), ie)
            CALL PUSHREAL8ARRAY(bl(2), ie)
            CALL PERT_PPM(1, u(2, j), bl(2), br(2), -1)
            CALL PUSHCONTROL1B(0)
          ELSE
            CALL PUSHCONTROL1B(1)
...
&               j)*u(npx+1, j))/(dx(npx, j)+dx(npx+1, j))
              ...
              CALL PUSHCONTROL1B(1)
            END IF
            CALL PUSHREAL8ARRAY(br(npx-2), ie - npx + 4)
            CALL PUSHREAL8ARRAY(bl(npx-2), ie - npx + 4)
            CALL PERT_PPM(1, u(npx-2, j), bl(npx-2), br(npx-2), -1)
            CALL PUSHCONTROL2B(2)
          ELSE
            CALL PUSHCONTROL2B(1)
...
!  Differentiation of xtp_u in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a
...
!compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_tracer fv
!_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_mod.ppm
!_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_mod.mo
!ist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_mod.tr
!acer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_utils_mo
!d.Riem_Solver3test nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_utils_mod.
!SIM1_solver nh_utils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_mod.c_s
!w sw_core_mod.d_sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fill3_4c
!orners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_divergence_d
!amping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corners tp
!_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_core_mod
!.edge_interpolate4)):
!   gradient     of useful results: flux u c
!   with respect to varying inputs: flux u c
...
&   u_ad, v, flux, flux_ad, iord, dx, rdx, npx, npy, grid_type, nested)
    ...
    IF (branch .EQ. 0) THEN
      ...
      END DO
    ELSE IF (branch .EQ. 1) THEN
      CALL POPREAL8ARRAY(fx0, ie - is + 2)
      CALL POPINTEGER4(ie3)
      CALL POPREAL8ARRAY(b0, ie - is + 3)
      CALL POPREAL8(min2)
      CALL POPREAL8(min1)
      CALL POPREAL8ARRAY(br, ie - is + 3)
      CALL POPREAL8ARRAY(bl, ie - is + 3)
...
&             )
        ...
        ELSE
          IF (branch .NE. 1) THEN
            CALL POPREAL8ARRAY(bl(npx-2), ie - npx + 4)
            CALL POPREAL8ARRAY(br(npx-2), ie - npx + 4)
...
&               2, j))*temp_ad12
          ...
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            CALL POPREAL8ARRAY(bl(2), ie)
            CALL POPREAL8ARRAY(br(2), ie)
...
!  Differentiation of ytp_v in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2
!b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core_mod.p
!_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.mix_dp
! dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayleigh_Supe
!r fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid_
...
!   with respect to varying inputs: v c
  SUBROUTINE YTP_V_FWD(is, ie, js, je, isd, ied, jsd, jed, c, u, v, flux&
...
&               1))
          ...
          END DO
        END DO
        CALL PUSHREAL8ARRAY(bl, (ie-is+2)*(je-js+3))
        CALL PUSHINTEGER4(je3)
        CALL PUSHREAL8ARRAY(br, (ie-is+2)*(je-js+3))
        CALL PUSHINTEGER4(js3)
        CALL PUSHREAL8ARRAY(b0, (ie-is+2)*(je-js+3))
        CALL PUSHCONTROL3B(1)
...
! in
          ...
          j = 2
          arg1 = ie - is + 2
          CALL PUSHREAL8ARRAY(br(is, j), ie - is + 2)
          CALL PUSHREAL8ARRAY(bl(is, j), ie - is + 2)
...
!  Differentiation of ytp_v in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a
!2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core_mod.
!p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.mix_d
!p dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayleigh_Sup
!er fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv_grid
...
!   gradient     of useful results: flux v c
!   with respect to varying inputs: v c
  SUBROUTINE YTP_V_BWD(is, ie, js, je, isd, ied, jsd, jed, c, c_ad, u, v&
&   , v_ad, flux, flux_ad, jord, dy, rdy, npx, npy, grid_type, nested)
    ...
    IF (branch .LT. 3) THEN
      IF (branch .EQ. 0) THEN
        ...
        GOTO 120
      ELSE IF (branch .EQ. 1) THEN
        CALL POPREAL8ARRAY(b0, (ie-is+2)*(je-js+3))
        CALL POPINTEGER4(js3)
        CALL POPREAL8ARRAY(br, (ie-is+2)*(je-js+3))
        CALL POPINTEGER4(je3)
        CALL POPREAL8ARRAY(bl, (ie-is+2)*(je-js+3))
        bl_ad = 0.0_8
        br_ad = 0.0_8
        b0_ad = 0.0_8
        DO j=je+1,js,-1
...
&               flux_ad(i, j)
          ...
          ELSE
            ...
            temp_ad5 = (1.-cfl)*flux_ad(i, j)
            v_ad(i, j-1) = v_ad(i, j-1) + flux_ad(i, j)
            cfl_ad = -(b0(i, j-1)*temp_ad5) - (br(i, j-1)-cfl*b0(i, j-1)&
&             )*flux_ad(i, j)
      ...
      DO j=je+1,js,-1
        DO i=ie+1,is,-1
          ...
          IF (branch .EQ. 0) THEN
            ...
            cfl = c(i, j)*rdy(i, j-1)
            temp_ad7 = (1.-cfl)*fx0_ad(i)
            cfl_ad = -(b0(i, j-1)*temp_ad7) - (br(i, j-1)-cfl*b0(i, j-1)&
&             )*fx0_ad(i)
          ...
          ELSE
            ...
            cfl = c(i, j)*rdy(i, j)
            temp_ad8 = (cfl+1.)*fx0_ad(i)
            cfl_ad = b0(i, j)*temp_ad8 + (bl(i, j)+cfl*b0(i, j))*fx0_ad(&
&             i)
...
&             , j)
      ...
      ELSE
        ...
        ELSE
          j = npy - 2
          arg1 = ie - is + 2
          CALL POPREAL8ARRAY(bl(is, j), ie - is + 2)
          CALL POPREAL8ARRAY(br(is, j), ie - is + 2)
...
&         temp_ad2
    ...
    DO i=ie+1,is,-1
      ...
      v_ad(i, 0) = v_ad(i, 0) + (dy(i, 0)*2.+dy(i, -1))*temp_ad - br_ad(&
&       i, 0)
      br_ad(i, 0) = 0.0_8
...
!  Differentiation of d2a2c_vect in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_m
...
!mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_trace
!r fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_mod
!.ppm_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_mo
!d.moist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_mo
!d.tracer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_util
!s_mod.Riem_Solver3test nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_utils_
!mod.SIM1_solver nh_utils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_mod
!.c_sw sw_core_mod.d_sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fill
!3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_divergen
!ce_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corner
!s tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_core
!_mod.edge_interpolate4)):
...
! Local
    ...
    uc = 0.0
    vc = 0.0
    CALL PUSHREAL8ARRAY(ua, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    ua = 0.0
    CALL PUSHREAL8ARRAY(va, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    va = 0.0
    CALL PUSHREAL8ARRAY(ut, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    ut = 0.0
    CALL PUSHREAL8ARRAY(vt, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    vt = 0.0
    IF (dord4) THEN
      id = 1
    ELSE
...
&             +vtmp(i, j))
      ...
      !CALL PUSHPOINTER8(dxa)
      !CALL PUSHPOINTER8(cosa_v)
      CALL PUSHINTEGER4(jsd)
      CALL PUSHINTEGER4(ilast)
      CALL PUSHINTEGER4(ied)
      !CALL PUSHPOINTER8(sin_sg)
      !CALL PUSHPOINTER8(dya)
      CALL PUSHINTEGER4(ie)
      !CALL PUSHPOINTER8(rsin_v)
      CALL PUSHINTEGER4(isd)
      CALL PUSHINTEGER4(min1)
      CALL PUSHINTEGER4(min3)
...
!  Differentiation of d2a2c_vect in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_
...
!_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_trac
!er fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_mo
!d.ppm_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_m
!od.moist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_m
!od.tracer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_uti
!ls_mod.Riem_Solver3test nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_utils
!_mod.SIM1_solver nh_utils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_mo
!d.c_sw sw_core_mod.d_sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fil
!l3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_diverge
!nce_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corne
!rs tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_cor
!e_mod.edge_interpolate4)):
!   gradient     of useful results: u v ua uc ut va vc vt
!   with respect to varying inputs: u v
!There is a limit to how far this routine can fill uc and vc in the
! halo, and so either mpp_update_domains or some sort of boundary
...
&   , vt_ad
    ...
    IF (branch .EQ. 0) THEN
      ...
      CALL POPINTEGER4(min3)
      CALL POPINTEGER4(min1)
      CALL POPINTEGER4(isd)
      rsin_v => gridstruct%rsin_v
      !CALL ADMM_REBASE(rsin_v)
      CALL POPINTEGER4(ie)
      dya => gridstruct%dya
      !CALL ADMM_REBASE(dya)
      sin_sg => gridstruct%sin_sg
      !CALL ADMM_REBASE(sin_sg)
      CALL POPINTEGER4(ied)
      CALL POPINTEGER4(ilast)
      CALL POPINTEGER4(jsd)
      cosa_v => gridstruct%cosa_v
      !CALL ADMM_REBASE(cosa_v)
      dxa => gridstruct%dxa
      !CALL ADMM_REBASE(dxa)
...
&           temp_ad1
      ...
      END DO
    END IF
    CALL POPREAL8ARRAY(vt, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    CALL POPREAL8ARRAY(ut, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    CALL POPREAL8ARRAY(va, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    CALL POPREAL8ARRAY(ua, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
...
!  Differentiation of edge_interpolate4 in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b
...
!v_mapz_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.map
!n_tracer fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_m
!apz_mod.ppm_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_
!mapz_mod.moist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_trac
!er2d_mod.tracer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c 
...
!od.fill3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_d
!ivergence_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy
!_corners tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist 
!sw_core_mod.edge_interpolate4)):
...
!  Differentiation of edge_interpolate4 in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2
...
!fv_mapz_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.ma
!pn_tracer fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_
!mapz_mod.ppm_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv
!_mapz_mod.moist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tra
!cer2d_mod.tracer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c
...
!mod.fill3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_
!divergence_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.cop
!y_corners tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist
! sw_core_mod.edge_interpolate4)):
!   gradient     of useful results: ua edge_interpolate4
!   with respect to varying inputs: ua
...
!  Differentiation of fill2_4corners in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_ed
...
! 1: x-dir; 2: y-dir
    ...
    CASE (1) 
      IF (sw_corner) THEN
        CALL PUSHREAL8(q1(-1, 0))
        q1(-1, 0) = q1(0, 2)
        CALL PUSHREAL8(q1(0, 0))
        q1(0, 0) = q1(0, 1)
        CALL PUSHREAL8(q2(-1, 0))
        q2(-1, 0) = q2(0, 2)
        CALL PUSHREAL8(q2(0, 0))
        q2(0, 0) = q2(0, 1)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      END IF
      IF (se_corner) THEN
        CALL PUSHREAL8(q1(npx+1, 0))
        q1(npx+1, 0) = q1(npx, 2)
        CALL PUSHREAL8(q1(npx, 0))
        q1(npx, 0) = q1(npx, 1)
        CALL PUSHREAL8(q2(npx+1, 0))
        q2(npx+1, 0) = q2(npx, 2)
        CALL PUSHREAL8(q2(npx, 0))
        q2(npx, 0) = q2(npx, 1)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      END IF
      IF (nw_corner) THEN
        CALL PUSHREAL8(q1(0, npy))
        q1(0, npy) = q1(0, npy-1)
        CALL PUSHREAL8(q1(-1, npy))
        q1(-1, npy) = q1(0, npy-2)
        CALL PUSHREAL8(q2(0, npy))
        q2(0, npy) = q2(0, npy-1)
        CALL PUSHREAL8(q2(-1, npy))
        q2(-1, npy) = q2(0, npy-2)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      END IF
      IF (ne_corner) THEN
        CALL PUSHREAL8(q1(npx, npy))
        q1(npx, npy) = q1(npx, npy-1)
        CALL PUSHREAL8(q1(npx+1, npy))
        q1(npx+1, npy) = q1(npx, npy-2)
        CALL PUSHREAL8(q2(npx, npy))
        q2(npx, npy) = q2(npx, npy-1)
        CALL PUSHREAL8(q2(npx+1, npy))
        q2(npx+1, npy) = q2(npx, npy-2)
        CALL PUSHCONTROL3B(2)
      ELSE
        CALL PUSHCONTROL3B(1)
    ...
    CASE (2) 
      IF (sw_corner) THEN
        CALL PUSHREAL8(q1(0, 0))
        q1(0, 0) = q1(1, 0)
        CALL PUSHREAL8(q1(0, -1))
        q1(0, -1) = q1(2, 0)
        CALL PUSHREAL8(q2(0, 0))
        q2(0, 0) = q2(1, 0)
        CALL PUSHREAL8(q2(0, -1))
        q2(0, -1) = q2(2, 0)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      ...
      IF (se_corner) THEN
        CALL PUSHREAL8(q1(npx, 0))
        q1(npx, 0) = q1(npx-1, 0)
        CALL PUSHREAL8(q1(npx, -1))
        q1(npx, -1) = q1(npx-2, 0)
        CALL PUSHREAL8(q2(npx, 0))
        q2(npx, 0) = q2(npx-1, 0)
        CALL PUSHREAL8(q2(npx, -1))
        q2(npx, -1) = q2(npx-2, 0)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      ...
      IF (nw_corner) THEN
        CALL PUSHREAL8(q1(0, npy))
        q1(0, npy) = q1(1, npy)
        CALL PUSHREAL8(q1(0, npy+1))
        q1(0, npy+1) = q1(2, npy)
        CALL PUSHREAL8(q2(0, npy))
        q2(0, npy) = q2(1, npy)
        CALL PUSHREAL8(q2(0, npy+1))
        q2(0, npy+1) = q2(2, npy)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      ...
      IF (ne_corner) THEN
        CALL PUSHREAL8(q1(npx, npy))
        q1(npx, npy) = q1(npx-1, npy)
        CALL PUSHREAL8(q1(npx, npy+1))
        q1(npx, npy+1) = q1(npx-2, npy)
        CALL PUSHREAL8(q2(npx, npy))
        q2(npx, npy) = q2(npx-1, npy)
        CALL PUSHREAL8(q2(npx, npy+1))
        q2(npx, npy+1) = q2(npx-2, npy)
        CALL PUSHCONTROL3B(4)
      ELSE
        CALL PUSHCONTROL3B(3)
...
!  Differentiation of fill2_4corners in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_e
...
!mapz_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_
!tracer fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_map
!z_mod.ppm_profile fv_mapz_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_ma
!pz_mod.moist_cp fv_mapz_mod.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer
!2d_mod.tracer_2d_nested nh_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh
...
!.fill3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_div
!ergence_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_c
!orners tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw
!_core_mod.edge_interpolate4)):
!   gradient     of useful results: q1 q2
!   with respect to varying inputs: q1 q2
...
!  Differentiation of fill_4corners in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edg
!e_mod.a2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_co
!re_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mo
!d.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayle
!igh_Super fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos 
...
! 1: x-dir; 2: y-dir
    ...
    CASE (1) 
      IF (sw_corner) THEN
        CALL PUSHREAL8(q(-1, 0))
        q(-1, 0) = q(0, 2)
        CALL PUSHREAL8(q(0, 0))
        q(0, 0) = q(0, 1)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      END IF
      IF (se_corner) THEN
        CALL PUSHREAL8(q(npx+1, 0))
        q(npx+1, 0) = q(npx, 2)
        CALL PUSHREAL8(q(npx, 0))
        q(npx, 0) = q(npx, 1)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      END IF
      IF (nw_corner) THEN
        CALL PUSHREAL8(q(0, npy))
        q(0, npy) = q(0, npy-1)
        CALL PUSHREAL8(q(-1, npy))
        q(-1, npy) = q(0, npy-2)
        CALL PUSHCONTROL1B(0)
      ELSE
        CALL PUSHCONTROL1B(1)
      END IF
      IF (ne_corner) THEN
        CALL PUSHREAL8(q(npx, npy))
        q(npx, npy) = q(npx, npy-1)
        CALL PUSHREAL8(q(npx+1, npy))
...
!  Differentiation of fill_4corners in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_ed
!ge_mod.a2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_c
!ore_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_m
!od.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayl
!eigh_Super fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos
...
!  Differentiation of compute_divergence_damping in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b
!_ord4 a2b_edge_mod.a2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.
...
!e dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynam
!ics_mod.Rayleigh_Super fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod
!.fv3_to_geos fv_grid_utils_mod.cubed_to_latlon fv_grid_utils_mod.c2l_ord4 fv_grid_utils_mod.c2l_ord2 fv_mapz_mod.Lagrangian_to_E
!ulerian fv_mapz_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_map
!z_mod.mapn_tracer fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limi
...
!sw_core_mod.fill3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.
!compute_divergence_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core
!_mod.copy_corners tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_cir
...
! Interpolate relative vort to cell corners
        CALL A2B_ORD4_FWD(wk, vort, gridstruct, npx, npy, is, ie, js, je&
&                   , ng, .false.)
        DO j=js,je+1
          DO i=is,ie+1
            IF (dt .GE. 0.) THEN
...
!  Differentiation of compute_divergence_damping in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2
!b_ord4 a2b_edge_mod.a2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod
...
!te dyn_core_mod.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dyna
!mics_mod.Rayleigh_Super fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mo
!d.fv3_to_geos fv_grid_utils_mod.cubed_to_latlon fv_grid_utils_mod.c2l_ord4 fv_grid_utils_mod.c2l_ord2 fv_mapz_mod.Lagrangian_to_
!Eulerian fv_mapz_mod.compute_total_energy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_ma
!pz_mod.mapn_tracer fv_mapz_mod.map1_q2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_lim
...
! sw_core_mod.fill3_4corners sw_core_mod.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod
!.compute_divergence_damping sw_core_mod.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_cor
!e_mod.copy_corners tp_core_mod.xppm tp_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_ci
      ...
      ELSE IF (branch .EQ. 1) THEN
        DO j=je+1,js,-1
          DO i=ie+1,is,-1
            ...
            IF (delpc(i, j)**2 + vort(i, j)**2 .EQ. 0.0_8) THEN
              temp_ad9 = 0.0
            ELSE
...
&               vort(i, j)**2))
        ...
        npx = flagstruct%npx
        npy = flagstruct%npy
        CALL A2B_ORD4_BWD(wk, wk_ad, vort, vort_ad, gridstruct, npx, npy&
...
!  Differentiation of smag_corner in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_
!mod.a2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_core
!_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod.
!mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Rayleig
!h_Super fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos fv
...
! Compute shear strain:
    ...
    DO j=jsd,jed
      ...
      END DO
    END DO
    CALL A2B_ORD4_FWD(wk, sh, gridstruct, npx, npy, is, ie, js, je, ng, &
&               .false.)
    DO j=js,je+1
      DO i=is,ie+1
        CALL PUSHREAL8(smag_c(i, j))
    ...
    !CALL PUSHPOINTER8(dx)
    !CALL PUSHPOINTER8(dy)
    !CALL PUSHPOINTER8(rarea_c)
    !CALL PUSHPOINTER8(dyc)
    CALL PUSHREAL8ARRAY(sh, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    CALL PUSHINTEGER4(is)
    CALL PUSHINTEGER4(jed)
  END SUBROUTINE SMAG_CORNER_FWD
!  Differentiation of smag_corner in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge
!_mod.a2b_ord2 dyn_core_mod.dyn_core dyn_core_mod.pk3_halo dyn_core_mod.pln_halo dyn_core_mod.pe_halo dyn_core_mod.adv_pe dyn_cor
!e_mod.p_grad_c dyn_core_mod.nh_p_grad dyn_core_mod.split_p_grad dyn_core_mod.one_grad_p dyn_core_mod.grad1_p_update dyn_core_mod
!.mix_dp dyn_core_mod.geopk dyn_core_mod.del2_cubed dyn_core_mod.Rayleigh_fast fv_dynamics_mod.fv_dynamics fv_dynamics_mod.Raylei
!gh_Super fv_dynamics_mod.Rayleigh_Friction fv_dynamics_mod.compute_aam fv_dynamics_mod.geos_to_fv3 fv_dynamics_mod.fv3_to_geos f
...
&   smag_c_ad, bd, npx, npy, gridstruct, ng)
    ...
    CALL POPINTEGER4(jed)
    CALL POPINTEGER4(is)
    CALL POPREAL8ARRAY(sh, (bd%ied-bd%isd+1)*(bd%jed-bd%jsd+1))
    dyc => gridstruct%dyc
    !CALL ADMM_REBASE(dyc)
    rarea_c => gridstruct%rarea_c
    !CALL ADMM_REBASE(rarea_c)
    dy => gridstruct%dy
    !CALL ADMM_REBASE(dy)
    dx => gridstruct%dx
    !CALL ADMM_REBASE(dx)
    ...
    DO j=je+1,js,-1
      DO i=ie+1,is,-1
        CALL POPREAL8(smag_c(i, j))
        IF (sh(i, j)**2 + smag_c(i, j)**2 .EQ. 0.0_8) THEN
          temp_ad1 = 0.0
        ELSE
...
&           j)**2))
    ...
    END DO
    wk_ad = 0.0_8
    CALL A2B_ORD4_BWD(wk, wk_ad, sh, sh_ad, gridstruct, npx, npy, is, ie&
&               , js, je, ng, .false.)
    rarea => gridstruct%rarea
    jsd = bd%jsd
    ied = bd%ied
