...
& mpp_update_domains_adm, dgrid_ne, mpp_global_sum
  USE MPP_DOMAINS_MOD_B, ONLY : domain2d, bitwise_efp_sum
  USE FV_ARRAYS_MOD_B, ONLY : fv_atmos_type, fv_grid_type, &
& fv_grid_bounds_type, r_grid
  USE FV_MP_MOD_B, ONLY : ng, is_master
...
!  Differentiation of c2l_ord2 in reverse (adjoint) mode, forward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod
...
! 2nd order:
    ...
    !CALL PUSHPOINTER8(a21)
    !CALL PUSHPOINTER8(a22)
    !CALL PUSHPOINTER8(dx)
    !CALL PUSHPOINTER8(dy)
    CALL PUSHINTEGER4(ie)
    CALL PUSHINTEGER4(is)
    !CALL PUSHPOINTER8(a11)
    !CALL PUSHPOINTER8(a12)
    CALL PUSHINTEGER4(je)
  END SUBROUTINE C2L_ORD2_FWD
!  Differentiation of c2l_ord2 in reverse (adjoint) mode, backward sweep (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mo
...
&   gridstruct, km, grid_type, bd, do_halo)
    ...
    CALL POPINTEGER4(je)
    a12 => gridstruct%a12
    !CALL ADMM_REBASE(a12)
    a11 => gridstruct%a11
    !CALL ADMM_REBASE(a11)
    CALL POPINTEGER4(is)
    CALL POPINTEGER4(ie)
    dy => gridstruct%dy
    !CALL ADMM_REBASE(dy)
    ...
    !CALL ADMM_REBASE(dx)
    a22 => gridstruct%a22
    !CALL ADMM_REBASE(a22)
    a21 => gridstruct%a21
    !CALL ADMM_REBASE(a21)
    CALL POPINTEGER4(js)
    wu_ad = 0.0_8
    v1_ad = 0.0_8
    wv_ad = 0.0_8
...
!  Differentiation of g_sum in reverse (adjoint) mode (with options r8 split(a2b_edge_mod.a2b_ord4 a2b_edge_mod.a2b_ord2 dyn_core
...
!ergy fv_mapz_mod.pkez fv_mapz_mod.remap_z fv_mapz_mod.map_scalar fv_mapz_mod.map1_ppm fv_mapz_mod.mapn_tracer fv_mapz_mod.map1_q
!2 fv_mapz_mod.remap_2d fv_mapz_mod.scalar_profile fv_mapz_mod.cs_profile fv_mapz_mod.cs_limiters fv_mapz_mod.ppm_profile fv_mapz
!_mod.ppm_limiters fv_mapz_mod.steepz fv_mapz_mod.rst_remap fv_mapz_mod.mappm fv_mapz_mod.moist_cv fv_mapz_mod.moist_cp fv_mapz_m
!od.map1_cubic fv_restart_mod.d2c_setup fv_tracer2d_mod.tracer_2d_1L fv_tracer2d_mod.tracer_2d fv_tracer2d_mod.tracer_2d_nested n
!h_core_mod.Riem_Solver3 nh_utils_mod.update_dz_c nh_utils_mod.update_dz_d nh_utils_mod.Riem_Solver_c nh_utils_mod.Riem_Solver3te
!st nh_utils_mod.imp_diff_w nh_utils_mod.RIM_2D nh_utils_mod.SIM3_solver nh_utils_mod.SIM3p0_solver nh_utils_mod.SIM1_solver nh_u
!tils_mod.SIM_solver nh_utils_mod.edge_scalar nh_utils_mod.edge_profile nh_utils_mod.nest_halo_nh sw_core_mod.c_sw sw_core_mod.d_
!sw  sw_core_mod.divergence_corner sw_core_mod.divergence_corner_nest sw_core_mod.d2a2c_vect sw_core_mod.fill3_4corners sw_core_m
!od.fill2_4corners sw_core_mod.fill_4corners sw_core_mod.xtp_u sw_core_mod.ytp_v sw_core_mod.compute_divergence_damping sw_core_m
!od.smag_corner sw_core_mod.del6_vt_flux tp_core_mod.mp_ghost_ew tp_core_mod.fv_tp_2d tp_core_mod.copy_corners tp_core_mod.xppm t
!p_core_mod.yppm tp_core_mod.deln_flux a2b_edge_mod.extrap_corner fv_grid_utils_mod.great_circle_dist sw_core_mod.edge_interpolat
!e4)):
