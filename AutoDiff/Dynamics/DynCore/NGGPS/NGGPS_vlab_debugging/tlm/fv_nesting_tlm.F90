...
!***********************************************************************
MODULE FV_NESTING_MOD_D
  USE MPP_DOMAINS_MOD_D, ONLY : mpp_update_domains, &
& mpp_update_domains_tlm
  USE MPP_DOMAINS_MOD_D, ONLY : mpp_global_field
  USE FIELD_MANAGER_MOD, ONLY : model_atmos
  USE TRACER_MANAGER_MOD, ONLY : get_tracer_index
  USE FV_SG_MOD, ONLY : neg_adj3
  USE MPP_DOMAINS_MOD_D, ONLY : mpp_get_data_domain, &
& mpp_get_compute_domain, mpp_get_global_domain
  USE MPP_DOMAINS_MOD_D, ONLY : dgrid_ne, mpp_update_domains, &
...
& mpp_error, fatal
  USE MPP_DOMAINS_MOD_D, ONLY : mpp_global_sum, bitwise_efp_sum, &
& bitwise_exact_sum
  USE BOUNDARY_MOD_D, ONLY : update_coarse_grid
  USE BOUNDARY_MOD_D, ONLY : nested_grid_bc_send, nested_grid_bc_recv, &
& nested_grid_bc_save_proc
  USE FV_MP_MOD_D, ONLY : is, ie, js, je, isd, ied, jsd, jed, isc, iec, &
& jsc, jec
  USE FV_ARRAYS_MOD_D, ONLY : fv_grid_type, fv_flags_type, fv_atmos_type&
& , fv_nest_type, fv_diag_type, fv_nest_bc_type_3d
  USE FV_ARRAYS_MOD_D, ONLY : allocate_fv_nest_bc_type, fv_atmos_type, &
& fv_grid_bounds_type
  USE FV_GRID_UTILS_MOD_D, ONLY : ptop_min, g_sum, g_sum_tlm, &
& cubed_to_latlon, f_p
  USE INIT_HYDRO_MOD_D, ONLY : p_var
  USE CONSTANTS_MOD, ONLY : grav, pi => pi_8, radius, hlv, rdgas, cp_air&
& , rvgas, cp_vapor, kappa
  USE FV_MAPZ_MOD_D, ONLY : mappm
  USE FV_TIMING_MOD, ONLY : timing_on, timing_off
  USE FV_MP_MOD_D, ONLY : is_master
  USE FV_MP_MOD_D, ONLY : mp_reduce_sum
  USE FV_DIAGNOSTICS_MOD_D, ONLY : sphum_ll_fix, range_check
  USE SW_CORE_MOD_D, ONLY : divergence_corner, divergence_corner_nest
  IMPLICIT NONE
...
&   pt, delp, delz, q, uc, vc, pkz, ng, gridstruct, flagstruct, &
&   neststruct, domain, bd, nwat)
    IMPLICIT NONE
...
&   ice_watbc_south, rainwatbc_south, snowwatbc_south, graupelbc_south
    REAL :: dp1, q_liq, q_sol, cvm, pkz, rdg, cv_air
    REAL, SAVE :: q_con=0.
    INTEGER :: i, j, k, istart, iend
