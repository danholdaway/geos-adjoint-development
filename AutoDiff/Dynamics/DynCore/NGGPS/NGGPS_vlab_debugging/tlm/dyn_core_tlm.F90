...
& a2b_ord4_tlm
  ...
  USE NH_UTILS_MOD_D, ONLY : riem_solver_c, riem_solver_c_tlm, &
...
& nest_halo_nh, nest_halo_nh_tlm
  ...
  USE FV_DIAGNOSTICS_MOD_D, ONLY : prt_maxmin, fv_time, prt_mxm
  USE FV_NWP_NUDGE_MOD_D, ONLY : breed_slp_inline, do_adiabatic_init
  USE DIAG_MANAGER_MOD, ONLY : send_data
  USE FV_ARRAYS_MOD_D, ONLY : fv_grid_type, fv_flags_type, fv_nest_type,&
& fv_diag_type, fv_grid_bounds_type, r_grid
  USE BOUNDARY_MOD_D, ONLY : extrapolation_bc, nested_grid_bc_apply_intt&
...
&                      delz, ws, ws_tl, rdt, gridstruct, bd, flagstruct%&
&                      hord_tm_pert)
...
!$OMP parallel do default(none) shared(is,ie,js,je,npz,pe,delp,ptop)
    DO j=js,je
      pe_tl(is-1, 1, j) = 0.0_8
      pe(is-1, 1, j) = ptop
      pe_tl(ie+1, 1, j) = 0.0_8
      pe(ie+1, 1, j) = ptop
      DO k=1,npz
...
!$OMP parallel do default(none) shared(is,ie,js,je,npz,pe,delp,ptop)
    DO i=is-1,ie+1
      pe_tl(i, 1, js-1) = 0.0_8
      pe(i, 1, js-1) = ptop
      pe_tl(i, 1, je+1) = 0.0_8
      pe(i, 1, je+1) = ptop
      DO k=1,npz
...
&                   js, je, ng, .true.)
      END IF
      CALL A2B_ORD4_TLM(gz(isd:ied, jsd:jed, k), gz_tl(isd:ied, jsd:jed&
&                 , k), wk1, wk1_tl, gridstruct, npx, npy, is, ie, js, &
&                 je, ng, .true.)
    END DO
    wk_tl = 0.0_8
...
!$OMP                          private(wk1, wk, du1, dv1)
    DO k=1,npz
      CALL A2B_ORD4_TLM(delp(isd:ied, jsd:jed, k), delp_tl(isd:ied, jsd:&
&                 jed, k), wk1, wk1_tl, gridstruct, npx, npy, is, ie, js&
&                 , je, ng)
      DO j=js,je+1
        DO i=is,ie+1
