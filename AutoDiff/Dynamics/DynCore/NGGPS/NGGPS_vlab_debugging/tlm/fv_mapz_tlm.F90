...
& mpp_update_domains_tlm, domain2d
  ...
  USE FV_ARRAYS_MOD_D, ONLY : fv_grid_type, fv_flags_type
  USE FV_TIMING_MOD, ONLY : timing_on, timing_off
  USE FV_MP_MOD_D, ONLY : is_master
  USE FV_CMP_MOD_D, ONLY : qs_init, fv_sat_adj
  USE FV_DIAGNOSTICS_MOD_D, ONLY : prt_mxm
  IMPLICIT NONE
!-----------------------------------------------------------------------
...
&                          q_tl, dp2, dp2_tl, kord_tr, j, is, ie, isd, &
&                          ied, jsd, jed, 0., fill)
          ELSE
            CALL MAPN_TRACER_TLM(nq, km, pe1, pe1_tl, pe2, pe2_tl, q, &
...
! Compute vertical subgrid distribution
    IF (kord .GT. 7) THEN
      CALL SCALAR_PROFILE_TLM(qs, q4, q4_tl, dp1, dp1_tl, km, i1, i2, iv&
&                       , kord, q_min)
      qsum_tl = 0.0_8
    ELSE
...
! Compute vertical subgrid distribution
    IF (kord .GT. 7) THEN
      CALL CS_PROFILE_TLM(qs, qs_tl, q4, q4_tl, dp1, dp1_tl, km, i1, i2&
&                   , iv, kord)
      qsum_tl = 0.0_8
    ELSE
      CALL PPM_PROFILE_TLM(q4, q4_tl, dp1, dp1_tl, km, i1, i2, iv, kord)
...
!   with respect to varying inputs: pe1 pe2 dp2 q1
  SUBROUTINE MAPN_TRACER_TLM(nq, km, pe1, pe1_tl, pe2, pe2_tl, q1, q1_tl&
&   , dp2, dp2_tl, kord, j, i1, i2, isd, ied, jsd, jed, q_min, fill)
    IMPLICIT NONE
! !INPUT PARAMETERS:
! vertical dimension
    INTEGER, INTENT(IN) :: km
...
&                       i1:i2, 1:km, iq), dp1, dp1_tl, km, i1, i2, 0, &
&                       kord(iq), q_min)
    END DO
    qsum_tl = 0.0_8
    q2_tl = 0.0_8
...
! Top 2 and bottom 2 layers always use monotonic mapping
      ...
      IF (iv .NE. 2) THEN
        DO i=i1,i2
          a4_tl(4, i, 1) = 3.*(2.*a4_tl(1, i, 1)-a4_tl(2, i, 1)-a4_tl(3&
&           , i, 1))
          a4(4, i, 1) = 3.*(2.*a4(1, i, 1)-(a4(2, i, 1)+a4(3, i, 1)))
        END DO
        CALL CS_LIMITERS_TLM(im, extm(i1, 1), a4(1, i1, 1), a4_tl(1, i1&
&                      , 1), 1)
      END IF
! k=2
      DO i=i1,i2
...
! Check within the smooth region if subgrid profile is non-monotonic
                    IF (abs9 .GT. abs16) THEN
                      ...
                      ELSE
                        ...
                        a4(3, i, k) = x8
                      END IF
                      a4_tl(4, i, k) = 6.*a4_tl(1, i, k) - 3.*(a4_tl(2, &
&                       i, k)+a4_tl(3, i, k))
...
! Right edges
                        ...
                        ELSE
                          ...
                          a4(3, i, k) = x10
                        END IF
                        a4_tl(4, i, k) = 3.*(2.*a4_tl(1, i, k)-a4_tl(2, &
&                         i, k)-a4_tl(3, i, k))
                        a4(4, i, k) = 3.*(2.*a4(1, i, k)-(a4(2, i, k)+a4&
&                         (3, i, k)))
                      END IF
                    ELSE
                      a4_tl(4, i, k) = 3.*(2.*a4_tl(1, i, k)-a4_tl(2, i&
&                       , k)-a4_tl(3, i, k))
...
! Right edges
                            ...
                            ELSE
                              ...
                              a4(3, i, k) = x12
                            END IF
                            a4_tl(4, i, k) = 3.*(2.*a4_tl(1, i, k)-a4_tl&
&                             (2, i, k)-a4_tl(3, i, k))
...
&           , i, k))
          a4(4, i, k) = 3.*(2.*a4(1, i, k)-(a4(2, i, k)+a4(3, i, k)))
        END DO
        IF (k .EQ. km - 1) CALL CS_LIMITERS_TLM(im, extm(i1, k), a4(1, &
&                                         i1, k), a4_tl(1, i1, k), 2)
