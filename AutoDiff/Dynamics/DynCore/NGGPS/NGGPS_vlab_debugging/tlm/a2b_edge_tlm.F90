...
&             qin(i, j))
      ...
      ELSE
        IF (gridstruct%sw_corner) THEN
          p0(1:2) = grid(1, 1, 1:2)
          result1_tl = EXTRAP_CORNER_TLM(p0, agrid(1, 1, 1:2), agrid(2, &
&           2, 1:2), qin(1, 1), qin_tl(1, 1), qin(2, 2), qin_tl(2, 2), &
&           result1)
          result2_tl = EXTRAP_CORNER_TLM(p0, agrid(0, 1, 1:2), agrid(-1&
&           , 2, 1:2), qin(0, 1), qin_tl(0, 1), qin(-1, 2), qin_tl(-1, 2&
&           ), result2)
          result3_tl = EXTRAP_CORNER_TLM(p0, agrid(1, 0, 1:2), agrid(2, &
&           -1, 1:2), qin(1, 0), qin_tl(1, 0), qin(2, -1), qin_tl(2, -1)&
&           , result3)
        ...
        IF (gridstruct%se_corner) THEN
          ...
          result1_tl = EXTRAP_CORNER_TLM(p0, agrid(npx-1, 1, 1:2), agrid&
&           (npx-2, 2, 1:2), qin(npx-1, 1), qin_tl(npx-1, 1), qin(npx-2&
&           , 2), qin_tl(npx-2, 2), result1)
          result2_tl = EXTRAP_CORNER_TLM(p0, agrid(npx-1, 0, 1:2), agrid&
&           (npx-2, -1, 1:2), qin(npx-1, 0), qin_tl(npx-1, 0), qin(npx-2&
&           , -1), qin_tl(npx-2, -1), result2)
          result3_tl = EXTRAP_CORNER_TLM(p0, agrid(npx, 1, 1:2), agrid(&
&           npx+1, 2, 1:2), qin(npx, 1), qin_tl(npx, 1), qin(npx+1, 2), &
...
&           ), qin(npx-2, npy+1), qin_tl(npx-2, npy+1), result3)
        ...
        IF (gridstruct%nw_corner) THEN
          ...
          result1_tl = EXTRAP_CORNER_TLM(p0, agrid(1, npy-1, 1:2), agrid&
&           (2, npy-2, 1:2), qin(1, npy-1), qin_tl(1, npy-1), qin(2, npy&
&           -2), qin_tl(2, npy-2), result1)
          result2_tl = EXTRAP_CORNER_TLM(p0, agrid(0, npy-1, 1:2), agrid&
&           (-1, npy-2, 1:2), qin(0, npy-1), qin_tl(0, npy-1), qin(-1, &
&           npy-2), qin_tl(-1, npy-2), result2)
          result3_tl = EXTRAP_CORNER_TLM(p0, agrid(1, npy, 1:2), agrid(2&
&           , npy+1, 1:2), qin(1, npy), qin_tl(1, npy), qin(2, npy+1), &
