...
!                q4:in
SUBROUTINE V2_MAPZ_Q_D(i1, i2, km, kn, pe1, pe2, dp1, dp2, q4d, q2, q2d)
  IMPLICIT NONE
!Inputs
...
&         , i, l))*(pr+pl)) - r3*(q4d(4, i, l)*(pr*(pr+pl)+pl**2))
        k0 = l
        GOTO 555
      ELSE
! Fractional area...
        qsumd = (pe1(i, l+1)-pe2(i, k))*(q4d(2, i, l)+0.5*((q4d(4, i, l&
&         )+q4d(3, i, l)-q4d(2, i, l))*(1.+pl))-r3*(q4d(4, i, l)*(1.+pl*(1.+pl))))
        DO m=l+1,km
! locate the bottom edge: pe2(i,k+1)
          IF (pe2(i, k+1) .GT. pe1(i, m+1)) THEN
! Whole layer..
            qsumd = qsumd + dp1(i, m)*q4d(1, i, m)
          ELSE
            GOTO 120
          END IF
        END DO
 ...
 120    dp = pe2(i, k+1) - pe1(i, m)
        esl = dp/dp1(i, m)
        qsumd = qsumd + dp*(q4d(2, i, m)+0.5*(esl*(q4d(3,i,m)-q4d(2, i, m)+q4d(4, i, m)*(1.-r23*esl))))
        k0 = m
      END IF
 123  q2d(i, k) = qsumd/dp2(i, k)
 555 CONTINUE
  END DO
