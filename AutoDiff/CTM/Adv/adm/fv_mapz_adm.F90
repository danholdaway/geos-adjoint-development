...
CONTAINS
!  Differentiation of map1_q2 in reverse (adjoint) mode:
!   gradient     of useful results: q1 q2
!   with respect to varying inputs: q1 q2
  SUBROUTINE MAP1_Q2_ADM(km, pe1, q1, q1_ad, kn, pe2, q2, q2_ad, dp2, i1&
    ...
    DO i=i2,i1,-1
      DO k=kn,1,-1
        ...
        IF (branch .EQ. 0) THEN
          ...
          temp_ad = (pr+pl)*0.5*q2_ad(i, k)
          q4_ad(2, i, l) = q4_ad(2, i, l) + q2_ad(i, k) - temp_ad
          q4_ad(4, i, l) = q4_ad(4, i, l) + temp_ad - (pr*(pr+pl)+pl**2)&
&           *r3*q2_ad(i, k)
          q4_ad(3, i, l) = q4_ad(3, i, l) + temp_ad
          q2_ad(i, k) = 0.0_8
        ELSE
          qsum_ad = qsum_ad + q2_ad(i, k)/dp2(i, k)
          q2_ad(i, k) = 0.0_8
          CALL POPCONTROL2B(branch)
          IF (branch .EQ. 0) THEN
            dp = pe2(i, k+1) - pe1(i, m)
            esl = dp/dp1(i, m)
            temp_ad2 = dp*esl*0.5*qsum_ad
            q4_ad(2, i, m) = q4_ad(2, i, m) + dp*qsum_ad - temp_ad2
            q4_ad(3, i, m) = q4_ad(3, i, m) + temp_ad2
            q4_ad(4, i, m) = q4_ad(4, i, m) + (1.-r23*esl)*temp_ad2
          ...
          END DO
          pl = (pe2(i, k)-pe1(i, l))/dp1(i, l)
          temp_ad0 = (pe1(i, l+1)-pe2(i, k))*qsum_ad
          temp_ad1 = (pl+1.)*0.5*temp_ad0
          q4_ad(2, i, l) = q4_ad(2, i, l) + temp_ad0 - temp_ad1
          q4_ad(4, i, l) = q4_ad(4, i, l) + temp_ad1 - (pl*(pl+1.)+1.)*&
&           r3*temp_ad0
          q4_ad(3, i, l) = q4_ad(3, i, l) + temp_ad1
          qsum_ad = 0.0_8
        END IF
 130    CALL POPINTEGER4(ad_count)
    ...
    CALL POPCONTROL2B(branch)
    IF (branch .NE. 0) THEN
      IF (branch .NE. 1) CALL CS_PROFILE_LINEAR_ADM(q4, q4_ad, dp1, km, &
&                                             i1, i2, iv)
    END IF
    DO k=km,1,-1
      DO i=i2,i1,-1
...
!  Differentiation of cs_profile_linear in reverse (adjoint) mode:
!   gradient     of useful results: a4
!   with respect to varying inputs: a4
  SUBROUTINE CS_PROFILE_LINEAR_ADM(a4, a4_ad, delp, km, i1, i2, iv)
    IMPLICIT NONE
...
! grid ratio
    ...
    DO k=km,1,-1
      DO i=i2,i1,-1
        temp_ad1 = 3.*a4_ad(4, i, k)
        a4_ad(1, i, k) = a4_ad(1, i, k) + 2.*temp_ad1
        a4_ad(2, i, k) = a4_ad(2, i, k) - temp_ad1
        a4_ad(3, i, k) = a4_ad(3, i, k) - temp_ad1
        a4_ad(4, i, k) = 0.0_8
    ...
    DO i=i2,i1,-1
      ...
      temp_ad0 = q_ad(i, km+1)/(d4(i)*(d4(i)+0.5)-a_bot*gam(i, km))
      a4_ad(1, i, km) = a4_ad(1, i, km) + d4(i)*2.*(d4(i)+1.)*temp_ad0
      a4_ad(1, i, km-1) = a4_ad(1, i, km-1) + temp_ad0
      q_ad(i, km) = q_ad(i, km) - a_bot*temp_ad0
      q_ad(i, km+1) = 0.0_8
    END DO
    DO k=km,2,-1
      DO i=i2,i1,-1
        ...
        a4_ad(1, i, k) = a4_ad(1, i, k) + 3.*d4(i)*temp_ad
    ...
    DO i=i2,i1,-1
      grat = delp(i, 2)/delp(i, 1)
      bet = grat*(grat+0.5)
      a4_ad(1, i, 1) = a4_ad(1, i, 1) + 2*grat*(grat+1.)*q_ad(i, 1)/bet
      a4_ad(1, i, 2) = a4_ad(1, i, 2) + q_ad(i, 1)/bet
      q_ad(i, 1) = 0.0_8
    END DO
