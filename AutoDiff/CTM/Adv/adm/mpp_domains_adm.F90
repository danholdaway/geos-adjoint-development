...
!  Differentiation of mpp_update_domain2d_3d in reverse (adjoint) mode:
!   gradient     of useful results: field1
!   with respect to varying inputs: field1
  SUBROUTINE MPP_UPDATE_DOMAIN2D_3D_ADM(field1, field1_ad, domain, &
&   gridtype, complete, whalo, ehalo, shalo, nhalo)
    IMPLICIT NONE
    REAL(real8), INTENT(INOUT) :: field1(:, :, :)
    REAL(real8), INTENT(INOUT) :: field1_ad(:, :, :)
    TYPE(DOMAIN2D), INTENT(IN) :: domain
    INTEGER, OPTIONAL, INTENT(IN) :: gridtype
    LOGICAL, OPTIONAL, INTENT(IN) :: complete
    INTEGER, OPTIONAL, INTENT(IN) :: whalo, ehalo, shalo, nhalo
...
!  Differentiation of mpp_update_domain2d_4d in reverse (adjoint) mode:
!   gradient     of useful results: field1
!   with respect to varying inputs: field1
  SUBROUTINE MPP_UPDATE_DOMAIN2D_4D_ADM(field1, field1_ad, domain, &
&   gridtype, complete, whalo, ehalo, shalo, nhalo)
    IMPLICIT NONE
    REAL(real8), INTENT(INOUT) :: field1(:, :, :, :)
    REAL(real8), INTENT(INOUT) :: field1_ad(:, :, :, :)
