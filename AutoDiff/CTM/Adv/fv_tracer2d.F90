...
!------------------------------------------------------------------
       do iq=1,nq
          ...
          !------------------------------------------------------
          scalingFactor = calcScalingFactor(q1, dp2, ple1, npx, npy, npz, is, ie, js, je)
...
!------------------------------------------------------------------------------------
         ...
         function calcScalingFactor(q1, dp2, ple1, npx, npy, npz, is, ie, js, je) result(scaling)
...
!------------------------------------------------------------------------------------
      ...
      function computeScalingFactors(q1, dp2, ple1, npx, npy, npz, is, ie, js, je) result(scaling)
         use mpp_mod, only: mpp_sum
         integer, intent(in) :: npx, is, ie, js, je
         integer, intent(in) :: npy
         integer, intent(in) :: npz
