...
!   RW status of diff variables: ssaa_dev:in wa_dev:in fcld_dev:in
!                cwc_dev:in flxu_dev:in-out ta_dev:in asya_dev:in
!                tb_dev:in dfdts_dev:in-out reff_dev:in taua_dev:in
!                flxd_dev:in-out oa_dev:in
...
!, flcu_dev, flau_dev
  ...
  REAL, DIMENSION(m, np+1), INTENT(INOUT) :: flxu_devd
!, flcd_dev, flad_dev
  REAL, DIMENSION(m, np + 1), INTENT(INOUT) :: flxd_dev
  REAL, DIMENSION(m, np+1), INTENT(INOUT) :: flxd_devd
  REAL, DIMENSION(m, np + 1), INTENT(INOUT) :: dfdts_dev
  REAL, DIMENSION(m, np+1), INTENT(INOUT) :: dfdts_devd
