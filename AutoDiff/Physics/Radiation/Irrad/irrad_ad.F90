...
!   RW status of diff variables: ssaa_dev:out wa_dev:out fcld_dev:out
!                cwc_dev:out flxu_dev:in-out ta_dev:out asya_dev:out
!                tb_dev:out dfdts_dev:in-out reff_dev:out taua_dev:out
!                flxd_dev:in-out oa_dev:out
...
&     xxb
  ...
  END DO
  asya_devb = 0.0
  asya_devb = asya_dev_tmpb
  ssaa_devb = 0.0
  ssaa_devb = ssaa_dev_tmpb
  taua_devb = 0.0
  taua_devb = taua_dev_tmpb
