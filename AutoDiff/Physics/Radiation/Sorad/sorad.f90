...
! !INPUT PARAMETERS:
      ...
      real,    intent(IN ) :: dp(nlevs)          !  Delta pressure (Pa)
...
!                
! !OUTPUT PARAMETERS:
      real,    intent(OUT) :: taubeam(nlevs,4)    !  Optical Depth for Beam Radiation
      real,    intent(OUT) :: taudiff(nlevs,4)    !  Optical Depth for Diffuse Radiation
      real,    intent(OUT) ::   asycl(nlevs  )    !  Cloud Asymmetry Factor
! !DESCRIPTION:
...
! !OUTPUT PARAMETERS:
      real,    intent(OUT) :: taubeam(nlevs,4)   !  Optical depth for beam radiation
      real,    intent(OUT) :: taudiff(nlevs,4)   !  Optical depth for diffuse radiation
      real,    intent(OUT) ::   ssacl(nlevs  )   !  Cloud single scattering albedo
      real,    intent(OUT) ::   asycl(nlevs  )   !  Cloud asymmetry factor
