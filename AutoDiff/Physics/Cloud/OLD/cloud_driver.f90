...
!ple          (d)- Pressure at level edge (Pa)
...
REAL(8), intent(in), dimension(IM,JM,LM) :: CNV_DQLDT, CNV_MFD, CNV_UPDF
...
REAL(8), intent(inout), dimension(IM,JM,LM) :: CNV_PRC3
...
REAL(8) :: T_tmp, q_tmp
REAL(8) :: QI_ls_tmp, QL_ls_tmp, QI_con_tmp, QL_con_tmp, CF_con_tmp, CF_ls_tmp
...
!CONS_CONSTANTS, REDEFINED FROM MAPL_CONSTATNS FOR USE IN AUTODIFF TOOL
real*8,  parameter :: CONS_PI_R8   = 3.14159265358979323846
REAL(8), parameter :: CONS_PI      = CONS_PI_R8
REAL(8), parameter :: CONS_GRAV    = 9.80665
REAL(8), parameter :: CONS_AIRMW   = 28.965
REAL(8), parameter :: CONS_H2OMW   = 18.015
REAL(8), parameter :: CONS_RUNIV   = 8314.47
REAL(8), parameter :: CONS_ALHL    = 2.4665E6
REAL(8), parameter :: CONS_ALHF    = 3.3370E5
REAL(8), parameter :: CONS_ALHS    = CONS_ALHL+CONS_ALHF
REAL(8), parameter :: CONS_RDRY    = CONS_RUNIV/CONS_AIRMW
REAL(8), parameter :: CONS_RVAP    = CONS_RUNIV/CONS_H2OMW
REAL(8), parameter :: CONS_CPDRY   = 3.5*CONS_RDRY
REAL(8), parameter :: CONS_KAPPA   = CONS_RDRY/CONS_CPDRY
REAL(8), parameter :: CONS_RGAS    = CONS_RDRY
REAL(8), parameter :: CONS_CP      = CONS_RGAS/CONS_KAPPA
REAL(8), parameter :: CONS_EPSILON = CONS_H2OMW/CONS_AIRMW
REAL(8), parameter :: CONS_VIREPS  = 1.0/CONS_EPSILON-1.0
REAL(8), parameter :: CONS_P00     = 100000.0
REAL(8), parameter :: CONS_TICE    = 273.16
...
REAL(8), parameter :: T_ICE_MAX = CONS_TICE
...
!Compute QS and DQSDT
 call DQSAT_sub(DQSDT,QS,T,Ph,im,jm,lm,ESTBLX)
...
!Clean up of excess realtive humidity
RHEXCESS = 1.1
call DQSAT_sub(DQSDT,QS,T,Ph,im,jm,lm,ESTBLX)
...
subroutine ls_cloud( DT, ALPHA, PDFSHAPE, PL, TE, QV, QCl, QAl, QCi, QAi, CF, AF, &
                     CONS_ALHL, CONS_ALHF, CONS_ALHS, CONS_CP, T_ICE_ALL, &
...
REAL(8), dimension(1) :: DQSx1,QSx1,TEo1,PL1
 ...
 call DQSAT_sub_sca(DQSx, QSx,TEo,PL,ESTBLX)
 ...
 do n=1,1
    ...
    call DQSAT_sub_sca(DQS, QSn, TEn, PL, ESTBLX)
...
REAL(8) :: ACF0, ACF, C00x, iQCcrx, F2, F3, RATE, dQP, QCm, dqfac
 ...
 CALL sundq3_func(TE, SUNDQV2, SUNDQV3, SUNDQT1, F2, F3 )
...
SUBROUTINE sundq3_func(TEMP,RATE2,RATE3,TE1, F2, F3)
...
subroutine ice_settlefall_cnv( WXR, QI, PL, TE, F, CONS_RGAS, Kh, DT, DZ, QP, ANV_ICEFALL_C )

IMPLICIT NONE

!Inputs
REAL(8), intent(in) :: WXR, PL, TE, Kh, DZ, DT, ANV_ICEFALL_C
...
subroutine ice_settlefall_ls( WXR, QI, PL, TE, F, CONS_RGAS, Kh, DT, DZ, QP, LS_ICEFALL_C )

IMPLICIT NONE

!Inputs
REAL(8), intent(in) :: WXR, PL, TE, Kh, DZ, DT, LS_ICEFALL_C
REAL(8), intent(in) :: CONS_RGAS
