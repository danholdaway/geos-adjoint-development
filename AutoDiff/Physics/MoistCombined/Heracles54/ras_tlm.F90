...
!
! $Id: ras.F90,v 1.24.2.8.2.1.4.2.2.1.14.1.2.1.2.1.12.1.34.1.32.1.2.1.22.1.4.1.20.1.2.3.6.5.24.3.4.3.6.2.2.2.2.6.4.3.30.1.12.1 20
!16-08-12 20:17:28 ltakacs Exp $
MODULE RAS_D
!use ESMF
!use GEOS_Mod
...
!%dpg(index)*1.61*MAPL8_PI !assumes a fixed sigma = 2.0
!
!         end do
...
!            DC=max((QICE0/(NIPRE*500.0*MAPL8_PI))**(0.333), 40.0e-6) !Assumme monodisperse size distribution about size distribu
!tion is made. 
!         else   
!            DC = 40.0e-6
!         end if
...
!         CNV_NICE,                                        & 
!         CNV_NDROP,                                    &   !DONIF
  SUBROUTINE RASE_TLM(idim, irun, k0, icmin, dt, doras, cpo, alhlo, &
