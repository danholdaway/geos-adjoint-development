...
MODULE MPP_DOMAINS_MOD_DIFF
  ...
  INTERFACE MPP_UPDATE_DOMAINS_ADM
      MODULE PROCEDURE MPP_UPDATE_DOMAIN2D_3D_R8_ADM
  END INTERFACE
...
!  Differentiation of mpp_update_domain2d_3d_r8 in reverse (adjoint) mode:
!   gradient     of useful results: field1
!   with respect to varying inputs: field1
  SUBROUTINE MPP_UPDATE_DOMAIN2D_3D_R8_ADM(field1, field1_ad, domain, &
&   gridtype, complete, whalo, ehalo, shalo, nhalo)
    IMPLICIT NONE
    REAL(kind=8), INTENT(INOUT) :: field1(:, :, :)
    REAL(kind=8), INTENT(INOUT) :: field1_ad(:, :, :)
    TYPE(DOMAIN2D), INTENT(IN) :: domain
    INTEGER, OPTIONAL, INTENT(IN) :: gridtype
    LOGICAL, OPTIONAL, INTENT(IN) :: complete
    INTEGER, OPTIONAL, INTENT(IN) :: whalo, ehalo, shalo, nhalo
    field1_ad = 2*field1_ad
  END SUBROUTINE MPP_UPDATE_DOMAIN2D_3D_R8_ADM
